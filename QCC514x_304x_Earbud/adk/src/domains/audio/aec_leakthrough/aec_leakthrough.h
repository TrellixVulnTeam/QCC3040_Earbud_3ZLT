...
typedef leakthrough_sync_data_t LEAKTHROUGH_UPDATE_STATE_IND_T;
typedef leakthrough_sync_data_t LEAKTHROUGH_UPDATE_MODE_IND_T;

/*! \brief Events sent by leakthrough module to the other modules */
typedef enum
{
    LEAKTHROUGH_UPDATE_STATE_IND =  LEAKTHROUGH_MESSAGE_BASE,
    LEAKTHROUGH_UPDATE_MODE_IND,

    LEAKTHROUGH_MESSAGE_END
}leakthrough_msg_t;
