...

{
    ...
    "layout": [
        ...
        ("apps_p0",         {"capacity": 157 * 4 * 1024,  "authenticate": True, "src_file_signed": True}),
        ("apps_p1",         {"capacity": 161 * 4 * 1024,  "authenticate": True, "src_file_signed": True}),
        ...
        ("ro_fs",           {"capacity":  91 * 4 * 1024,  "authenticate": False})
    ]
}
