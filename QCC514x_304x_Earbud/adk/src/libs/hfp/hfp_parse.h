...
struct hfpHandleVoiceRecognitionStatusText
{
  uint16 enable;
  uint16 textId;
  uint16 textOperation;
  struct sequence textStr;
  uint16 textType;
  uint16 vrecState;
};
struct hfpHandleVoiceRecognitionStatusState
{
  uint16 enable;
  uint16 vrecState;
};
...
void hfpHandleVoiceRecognitionStatusText(Task , const struct hfpHandleVoiceRecognitionStatusText *);
void hfpHandleVoiceRecognitionStatusState(Task , const struct hfpHandleVoiceRecognitionStatusState *);
