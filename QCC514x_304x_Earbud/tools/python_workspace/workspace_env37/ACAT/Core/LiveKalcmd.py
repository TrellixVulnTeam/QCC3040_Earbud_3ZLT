...
class DmAccessorKalcmd(kmem.DmAccessor):
...
class PmAccessorKalcmd(kmem.PmAccessor):
...
class LiveKalcmd(LiveChip.LiveChip):
    ...
    def __init__(self, kalcmd_object, processor):
        ...
        if kalimba_name == "csra68100_audio":
            ...
            chip_revision = 0
            chip_id = 0x4b
        elif kalimba_name == "QCC515x_audio":
            # AuraPlus 1.2
            chip_arch = "Hydra"
            chip_revision = 0x12
            chip_id = 0x4c
            ...
            chip_revision = 0x10
            chip_id = 0x50
        elif kalimba_name == "QCC517x_audio":
            # Mora 2.0
            chip_arch = "Hydra"
            chip_revision = 0x20
            chip_id = 0x50
