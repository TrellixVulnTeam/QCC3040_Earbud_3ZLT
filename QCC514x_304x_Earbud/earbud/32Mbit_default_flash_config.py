...

{
    ...
    "layout": [
        ...
        ("apps_p0",         {"capacity": 161 * 4 * 1024,  "authenticate": True, "src_file_signed": True}),
        ("apps_p1",         {"capacity": 212 * 4 * 1024,  "authenticate": False}),
        ...
        ("rw_config",       {"capacity":  16 * 4 * 1024}),
        ("ro_cfg_fs",       {"capacity":  51 * 4 * 1024,  "authenticate": False}),
        ("ro_fs",           {"capacity":  66 * 4 * 1024,  "authenticate": False})
    ]
}
