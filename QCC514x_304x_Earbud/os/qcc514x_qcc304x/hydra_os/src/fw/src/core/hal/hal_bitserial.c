...
/**
 * Interrupt handler for bitserial2 hardware interrupts.
 */
void hal_bitserial2_int_handler(void);
#endif
...
#endif
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            hal_int_handlers[2] = h;
            bitserial_int_config.block_id = HOST_SYS_BITSERIAL_2_BLOCK_ID;
            bitserial_int_config.handler = hal_bitserial2_int_handler;
            /* Enable bitserial bus interrupt */
            bus_interrupt_configure(BUS_INTERRUPT_ID_BITSERIAL2, 
                                                        &bitserial_int_config);
            break;
#endif
        default:
...
void *hal_bitserial_swint_handler_get(void)
{
    /*lint -e960 -e611 Suppress warnings about it being volatile */
    return (void *)hal_swint_handler;
}
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            hal_set_reg_bitserial2_interrupt_en(v);
            break;
#endif
        default:
            UNUSED(v);
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            return (uint16)hal_get_reg_bitserial2_interrupt_en();
#endif
        default:
            panic(PANIC_BITSERIAL_HAL_ERROR); /* Does not return */
    }
                             ...
                             mmu_handle txh1, mmu_handle rxh2, mmu_handle txh2)
{
    switch(i)
    {
        ...
        case BITSERIAL_INSTANCE_2:
            if(rxh1 != MMU_INDEX_NULL)
            {
                hal_set_bitserial2_remote_ssid_rx_buffer(mmu_handle_ssid(rxh1));
                hal_set_bitserial2_buff_handle_rx_buffer(mmu_handle_index(rxh1));
            }
            if(txh1 != MMU_INDEX_NULL)
            {
                hal_set_bitserial2_remote_ssid_tx_buffer(mmu_handle_ssid(txh1));
                hal_set_bitserial2_buff_handle_tx_buffer(mmu_handle_index(txh1));
            }
            if(rxh2 != MMU_INDEX_NULL)
            {
                hal_set_bitserial2_remote_ssid_rx_buffer2(mmu_handle_ssid(rxh2));
                hal_set_bitserial2_buff_handle_rx_buffer2(mmu_handle_index(rxh2));
            }
            if(txh2 != MMU_INDEX_NULL)
            {
                hal_set_bitserial2_remote_ssid_tx_buffer2(mmu_handle_ssid(txh2));
                hal_set_bitserial2_buff_handle_tx_buffer2(mmu_handle_index(txh2));
            }
            break;
#endif
        default:
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            hal_set_reg_host_sys_bitserial_2_data_output_pio_ctrl(v);
            break;
#endif
        default:
            UNUSED(v);
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            hal_set_reg_host_sys_bitserial_2_clk_output_pio_ctrl(v);
            break;
#endif
        default:
            UNUSED(v);
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            hal_set_reg_host_sys_bitserial_2_sel_output_pio_ctrl(v);
            break;
#endif
        default:
            UNUSED(v);
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            hal_set_reg_host_sys_bitserial_2_data_input_pio_ctrl(v);
            break;
#endif
        default:
            UNUSED(v);
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            hal_set_reg_host_sys_bitserial_2_clk_input_pio_ctrl(v);
            break;
#endif
        default:
            UNUSED(v);
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            hal_set_reg_host_sys_bitserial_2_sel_input_pio_ctrl(v);
            break;
#endif
        default:
            UNUSED(v);
...
void hal_bitserial_enable_set(bitserial_instance i, bool v)
{
    switch(i)
    {
        ...
        case BITSERIAL_INSTANCE_2:
            hal_set_register(*(volatile uint32 *)&HOST_SYS_CONFIG_ENABLES,
                             ((v) ? (hal_get_reg_host_sys_config_enables() | 
                                    (1 << HOST_SYS_BITSERIAL_2_BLOCK_ID)) 
                                  : (hal_get_reg_host_sys_config_enables() & 
                                    ~(1 << HOST_SYS_BITSERIAL_2_BLOCK_ID))
                             ), 1);
            break;
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            hal_set_reg_bitserial2_config(v);
            break;
#endif
        default:
            UNUSED(v);
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            return (uint16)hal_get_reg_bitserial2_config();
#endif
        default:
            panic(PANIC_BITSERIAL_HAL_ERROR); /* Does not return */
    }
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            hal_set_reg_bitserial2_config2(v);
            break;
#endif
        default:
            UNUSED(v);
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            hal_set_reg_bitserial2_config3(v);
            break;
#endif
        default:
            UNUSED(v);
...
bitserial_act_on_nak_bits hal_bitserial_act_on_nak_get(bitserial_instance i)
{
    uint16 v;
...
#if HAVE_NUMBER_OF_BITSERIALS > 0
        case BITSERIAL_INSTANCE_0:
            v = (uint16)hal_get_reg_bitserial0_config3();
            break;
#endif
#if HAVE_NUMBER_OF_BITSERIALS > 1
        case BITSERIAL_INSTANCE_1:
            v = (uint16)hal_get_reg_bitserial1_config3();
            break;
#endif
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            v = (uint16)hal_get_reg_bitserial2_config3();
            break;
#endif
        default:
            v=0;
    ...
    return (bitserial_act_on_nak_bits)(v & 3);
}
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            hal_set_reg_bitserial2_slave_underflow_byte(v);
            break;
#endif
        default:
            UNUSED(v);
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            return (uint16)hal_get_reg_bitserial2_config2();
#endif
        default:
            panic(PANIC_BITSERIAL_HAL_ERROR); /* Does not return */
    }
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            hal_set_reg_bitserial2_word_config(v);
            break;
#endif
        default:
            UNUSED(v);
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            return (uint16)hal_get_reg_bitserial2_word_config();
#endif
        default:
            panic(PANIC_BITSERIAL_HAL_ERROR); /* Does not return */
    }
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            hal_set_reg_bitserial2_interbyte_spacing(v);
            break;
#endif
        default:
            UNUSED(v);
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            hal_set_reg_bitserial2_config_sel_time((uint16)(v & 0xffff));
            hal_set_reg_bitserial2_config_sel_time2((uint16)((v >> 16) & 0xf));
            break;
#endif
        default:
            UNUSED(v);
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            hal_set_reg_bitserial2_clk_rate_hi(hi);
            hal_set_reg_bitserial2_clk_rate_lo(lo);
            break;
#endif
        default:
            UNUSED(hi);
...
void hal_bitserial_clk_rate_get(bitserial_instance i, uint16 *hi, uint16 *lo)
{
    if (hi == NULL || lo == NULL)
    {
        panic(PANIC_BITSERIAL_HAL_ERROR); /* Does not return */
...
#if HAVE_NUMBER_OF_BITSERIALS > 0
        case BITSERIAL_INSTANCE_0:
            *hi = (uint16)hal_get_reg_bitserial0_clk_rate_hi();
            *lo = (uint16)hal_get_reg_bitserial0_clk_rate_lo();
            break;
#endif
#if HAVE_NUMBER_OF_BITSERIALS > 1
        case BITSERIAL_INSTANCE_1:
            *hi = (uint16)hal_get_reg_bitserial1_clk_rate_hi();
            *lo = (uint16)hal_get_reg_bitserial1_clk_rate_lo();
            break;
#endif
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            *hi = (uint16)hal_get_reg_bitserial2_clk_rate_hi();
            *lo = (uint16)hal_get_reg_bitserial2_clk_rate_lo();
            break;
#endif
        default:
            UNUSED(hi);
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            hal_set_reg_bitserial2_clk_samp_offset(v);
            break;
#endif
        default:
            UNUSED(v);
...
uint16 hal_bitserial_clk_samp_offset_get(bitserial_instance i)
{
    switch(i)
    {
#if HAVE_NUMBER_OF_BITSERIALS > 0
        case BITSERIAL_INSTANCE_0:
            return (uint16)hal_get_reg_bitserial0_clk_samp_offset();
#endif
#if HAVE_NUMBER_OF_BITSERIALS > 1
        case BITSERIAL_INSTANCE_1:
            return (uint16)hal_get_reg_bitserial1_clk_samp_offset();
#endif
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            return (uint16)hal_get_reg_bitserial2_clk_samp_offset();
#endif
        default:
            panic(PANIC_BITSERIAL_HAL_ERROR); /* Does not return */
    }
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            hal_set_reg_bitserial2_i2c_address(v);
            break;
#endif
        default:
            UNUSED(v);
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            hal_set_reg_bitserial2_config(hal_get_reg_bitserial2_config() | 
                                   HAL_BITSERIAL_CONFIG_CLEAR_STICKY_ACK_MASK);
            hal_set_reg_bitserial2_config(hal_get_reg_bitserial2_config() & 
                                (~HAL_BITSERIAL_CONFIG_CLEAR_STICKY_ACK_MASK));
            break;
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            return (bitserial_events)hal_get_reg_bitserial2_interrupt_status();
#endif
        default:
            panic(PANIC_BITSERIAL_HAL_ERROR); /* Does not return */
    }
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            return hal_get_bitserial2_event();
#endif
        default:
            panic(PANIC_BITSERIAL_HAL_ERROR); /* Does not return */
    }
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            return (uint16)hal_get_reg_bitserial2_status();
#endif
        default:
            panic(PANIC_BITSERIAL_HAL_ERROR); /* Does not return */
    }
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            return (uint16)hal_get_reg_bitserial2_error_status();
#endif
        default:
            panic(PANIC_BITSERIAL_HAL_ERROR); /* Does not return */
    }
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            return hal_get_bitserial2_part_2();
#endif
        default:
            panic(PANIC_BITSERIAL_HAL_ERROR); /* Does not return */
    }
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            return hal_get_bitserial2_failed();
#endif
        default:
            panic(PANIC_BITSERIAL_HAL_ERROR); /* Does not return */
    }
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            hal_set_reg_bitserial2_interrupt_clear(event_mask);
            hal_set_reg_bitserial2_interrupt_clear(0);
            hal_set_reg_bitserial2_interrupt_source_clear(event_mask);
            hal_set_reg_bitserial2_interrupt_source_clear(0);
            break;
#endif
        default:
            panic(PANIC_BITSERIAL_HAL_ERROR); /* Does not return */
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            hal_set_host_sys_bitserial_2_clk_force_enable(enable ? 1:0);
            break;
#endif
        default:
            panic(PANIC_BITSERIAL_HAL_ERROR); /* Does not return */
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            return hal_get_bitserial2_busy();
#endif
        default:
            panic(PANIC_BITSERIAL_HAL_ERROR); /* Does not return */
    }
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            return (uint16)(hal_get_reg_bitserial2_i2c_acks() & 0x7fff);
#endif
        default:
            panic(PANIC_BITSERIAL_HAL_ERROR); /* Does not return */
    }
...
uint16 hal_bitserial_words_sent_get(bitserial_instance i)
{
    switch(i)
    {
#if HAVE_NUMBER_OF_BITSERIALS > 0
        case BITSERIAL_INSTANCE_0:
            return (uint16)(hal_get_reg_bitserial0_words_sent() & 0xffff);
#endif
#if HAVE_NUMBER_OF_BITSERIALS > 1
        case BITSERIAL_INSTANCE_1:
            return (uint16)(hal_get_reg_bitserial1_words_sent() & 0xffff);
#endif
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            return (uint16)(hal_get_reg_bitserial2_words_sent() & 0xffff);
#endif
        default:
            panic(PANIC_BITSERIAL_HAL_ERROR); /* Does not return */
    }
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            return (uint16)(hal_get_reg_bitserial2_rwb() & 0x3);
#endif
        default:
            panic(PANIC_BITSERIAL_HAL_ERROR); /* Does not return */
    }
...
uint16 hal_bitserial_txrx_length_get(bitserial_instance i)
{
    uint16 v = 0;
    switch(i)
    {
#if HAVE_NUMBER_OF_BITSERIALS > 0
        case BITSERIAL_INSTANCE_0:
            v = (uint16)hal_get_reg_bitserial0_txrx_length();
            break;
#endif
#if HAVE_NUMBER_OF_BITSERIALS > 1
        case BITSERIAL_INSTANCE_1:
            v = (uint16)hal_get_reg_bitserial1_txrx_length();
            break;
#endif
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            v = (uint16)hal_get_reg_bitserial2_txrx_length();
            break;
#endif
        default:
            panic(PANIC_BITSERIAL_HAL_ERROR); /* Does not return */
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            hal_set_reg_bitserial2_txrx_length(v);
            break;
#endif
        default:
            UNUSED(v);
...
uint16 hal_bitserial_txrx_length2_get(bitserial_instance i)
{
    uint16 v = 0;
    switch(i)
    {
#if HAVE_NUMBER_OF_BITSERIALS > 0
        case BITSERIAL_INSTANCE_0:
            v = (uint16)hal_get_reg_bitserial0_txrx_length2();
            break;
#endif
#if HAVE_NUMBER_OF_BITSERIALS > 1
        case BITSERIAL_INSTANCE_1:
            v = (uint16)hal_get_reg_bitserial1_txrx_length2();
            break;
#endif
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            v = (uint16)hal_get_reg_bitserial2_txrx_length2();
            break;
#endif
        default:
            panic(PANIC_BITSERIAL_HAL_ERROR); /* Does not return */
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            hal_set_reg_bitserial2_txrx_length2(v);
            break;
#endif
        default:
            UNUSED(v);
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            hal_set_reg_bitserial2_slave_num_protocol_words(v);
            break;
#endif
        default:
            UNUSED(v);
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            hal_set_reg_bitserial2_slave_read_command_byte(v);
            break;
#endif
        default:
            UNUSED(v);
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            return (uint16)hal_get_reg_bitserial2_slave_read_count();
#endif
        default:
            panic(PANIC_BITSERIAL_HAL_ERROR); /* Does not return */
    }
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            return (uint16)hal_get_reg_bitserial2_slave_write_count();
#endif
        default:
            panic(PANIC_BITSERIAL_HAL_ERROR); /* Does not return */
    }
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            return (uint16)hal_get_reg_bitserial2_clk_control();
#endif
        default:
            panic(PANIC_BITSERIAL_HAL_ERROR); /* Does not return */
    }
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            hal_set_reg_bitserial2_clk_control(v);
            break;
#endif
        default:
            panic(PANIC_BITSERIAL_HAL_ERROR); /* Does not return */
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            return (uint16)hal_get_bitserial2_config2_debug_sel();
#endif
        default:
            panic(PANIC_BITSERIAL_HAL_ERROR); /* Does not return */
    }
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            hal_set_bitserial2_config2_debug_sel(v);
            break;
#endif
        default:
            panic(PANIC_BITSERIAL_HAL_ERROR); /* Does not return */
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            hal_set_reg_bitserial2_debug_sel(v);
            break;
#endif
        default:
            panic(PANIC_BITSERIAL_HAL_ERROR); /* Does not return */
...
#if HAVE_NUMBER_OF_BITSERIALS > 2
        case BITSERIAL_INSTANCE_2:
            hal_set_reg_bitserial2_set_sel_inactive(v);
            break;
#endif
        default:
            panic(PANIC_BITSERIAL_HAL_ERROR); /* Does not return */
...
void hal_bitserial2_int_handler(void)
{
    if(hal_int_handlers[2])
    {
        hal_int_handlers[2](BITSERIAL_INSTANCE_2);
    }
}
#endif
