/*!
    ...
    \file chain_output_volume_mono_compander.c
...
static const operator_config_t operators[] =
{
    ...
    MAKE_OPERATOR_CONFIG_PRIORITY_MEDIUM(CAP_ID_COMPANDER, OPR_COMPANDER),
} ;
...
{
    {OPR_COMPANDER, EPR_SOURCE_MIXER_OUT, 0},
} ;

static const operator_connection_t connections[] =
{
    {OPR_SOURCE_SYNC, 0, OPR_VOLUME_CONTROL, 0, 1},
    {OPR_VOLUME_CONTROL, 0, OPR_COMPANDER, 0, 1},
} ;

const chain_config_t chain_output_volume_mono_compander_config = {0, 0, operators, 3, inputs, 2, outputs, 1, connections, 2};
