...
#define APPLICATION_PARAMETERS     0x4C
...
#define obexGetChannel( c ) (c.l2capObex)? c.u.psm[0]:c.u.channel
...
/* Defines SRM values */
#define OBEX_SRM_ENABLED                        0x01
#define OBEX_SRM_SUPPORTED                      0x02
...
struct __obex
{
    ...
    uint16       channel;        /* Associated RFCOMM Channel or L2CAP PSM*/
    ...
    ObexSrmStatus srm_status;             /* Status of srm */
    uint8         SRM;         /* SRM header, TRUE means PCE request enable SRM */
