...
#ifndef _CHAIN_SCO_SWB_3MIC_H__
#define _CHAIN_SCO_SWB_3MIC_H__

/*!
\page chain_sco_swb_3mic
    @startuml
...
extern const chain_config_t chain_sco_swb_3mic_config;

#endif /* _CHAIN_SCO_SWB_3MIC_H__ */
