...

{
    ...
    "layout": [
        ...
        ("curator_fs",      {"capacity":  16 2 * 4 * 1024,  "authenticate": False, "src_file_signed": False}),
        ("apps_p0",         {"capacity": 192 * 4 * 1024,  "authenticate": True, "src_file_signed": True}),
        ("apps_p1",         {"capacity": 160 * 4 * 1024,  "authenticate": False}),
        ...
        ("ro_fs",           {"capacity": 448 * 4 * 1024,  "authenticate": False})
    ]
}
