...
typedef struct _tag_AANC_PARAMETERS
{
	...
	ParamType OFFSET_FF_FINE_RAMP_UP_TIMER;
	ParamType OFFSET_FB_FINE_RAMP_UP_TIMER;
	ParamType OFFSET_FB_FINE_RAMP_DELAY_TIMER;
	ParamType OFFSET_MU_STEEP_FALL;
	ParamType OFFSET_GAIN_DROP_FRAME_COUNT;
	ParamType OFFSET_GAIN_MIN_FREEZ_TIME;
}AANC_PARAMETERS;
