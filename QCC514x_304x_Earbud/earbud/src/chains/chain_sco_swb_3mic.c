/*!
    ...
    \file chain_sco_swb_3mic.c
    \brief The chain_sco_swb_3mic chain.
...
static const operator_config_t operators[] =
{
    ...
    MAKE_OPERATOR_CONFIG(EB_CAP_ID_CVC_3MIC_SWB, OPR_CVC_SEND),
} ;
...
const chain_config_t chain_sco_swb_3mic_config = {1, 0, operators, 4, inputs, 5, outputs, 2, connections, 2};
