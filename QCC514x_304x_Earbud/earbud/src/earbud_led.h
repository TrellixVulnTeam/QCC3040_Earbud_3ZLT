...
#ifdef HAVE_RDP_UI
extern const led_pattern_t app_led_pattern_charging_complete[];
extern const led_pattern_t app_led_pattern_charging_error[];
#endif

extern const led_pattern_t app_led_pattern_charging_ok[];
extern const led_pattern_t app_led_pattern_charging_low[];
...
extern const led_pattern_t app_led_idle_production[];
extern const led_pattern_t app_led_in_ear_production[];
extern const led_pattern_t app_led_out_ear_production[];
#endif
...
#define appUiFCCDH5() \
    LedManager_SetPattern(app_led_pattern_dh5, LED_PRI_MEDIUM, NULL, 0)

/*! \brief Show LED pattern for FCC 2DH5 */
#define appUiFCC2DH5() \
    LedManager_SetPattern(app_led_pattern_2dh5, LED_PRI_MEDIUM, NULL, 0)

/*! \brief Show LED pattern for FCC 3DH5*/
#define appUiFCC3DH5() \
    LedManager_SetPattern(app_led_pattern_3dh5, LED_PRI_MEDIUM, NULL, 0)

/*! \brief Show LED pattern for idle production moder*/
#define appIdleProduction() \
    LedManager_SetPattern(app_led_idle_production, LED_PRI_MEDIUM, NULL, 0)

/*! \brief Show LED pattern for in ear*/
#define appInEarDetected() \
    LedManager_SetPattern(app_led_in_ear_production, LED_PRI_HIGH, NULL, 0)

/*! \brief Show LED pattern for in ear*/
#define appOutEarDetected() \
    LedManager_SetPattern(app_led_out_ear_production, LED_PRI_HIGH, NULL, 0)
