/*!
    ...
    \version %%version
    \file 
    \brief The hfp_profile_states marshal type definitions. This file is generated by C:/Qualcomm_Prog/QCC514x_304x_Earbud/adk/tools/packages/typegen/typegen.py.
*/
