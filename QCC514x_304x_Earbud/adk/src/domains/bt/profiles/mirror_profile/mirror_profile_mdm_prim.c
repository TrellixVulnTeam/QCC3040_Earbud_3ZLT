                                         ...
                                         l2ca_cid_t cid)
{
    ...
    MIRROR_LOG("MirrorProfile_MirrorL2capConnectRsp handle 0x%x cid 0x%x mtu %d", conn_handle, cid, a2dp->mtu);
    ...
    prim->conftab = (a2dp->mtu > 0x037f) ? (uint16*)l2cap_conftab_qhs : (uint16*)l2cap_conftab;
