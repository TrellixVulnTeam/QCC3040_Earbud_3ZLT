...
static const uint8 dfu_peer_service_record[] =
{
   /* Offset */ /* ServiceClassIDList(0x0001), Data Element Sequence */
    /*  0 */    SDP_ATTR_ID(UUID_SERVICE_CLASS_ID_LIST),
    /*  3 */        SDP_DATA_EL_SEQ(17),

    /*  UUID Qualcomm DFU Peer Service (0000eb05-d102-11e1-9b23-00025b00a5a5) */
    /*  5 */        SDP_DATA_EL_UUID128(UUID_DFU_PEER_SERVICE),
...
{
    return sizeof(dfu_peer_service_record);
}

const uint8 *appSdpGetDFUPeerServiceRecord(void)
{
    return dfu_peer_service_record;
}

/* DFU Peer Service search request */
static const uint8 dfu_peer_service_search_request[] =
{
    SDP_DATA_EL_SEQ(17),                     /* type = DataElSeq, 17 bytes in DataElSeq */
        SDP_DATA_EL_UUID128(UUID_DFU_PEER_SERVICE),
};

const uint8 *appSdpGetDFUPeerServiceSearchRequest(void)
{
    return dfu_peer_service_search_request;
}

uint16 appSdpGetDFUPeerServiceSearchRequestSize(void)
{
    return sizeof(dfu_peer_service_search_request);
}


/* DFU Peer Service attribute search request */
static const uint8 dfu_peer_attribute_list[] =
{
    SDP_DATA_EL_SEQ(3),                                /* Data Element Sequence of 3 */
        SDP_ATTR_ID(UUID_PROTOCOL_DESCRIPTOR_LIST),
};
...
{
    return dfu_peer_attribute_list;
}

uint16 appSdpGetDFUPeerAttributeSearchRequestSize(void)
{
    return sizeof(dfu_peer_attribute_list);
}
#endif
...
/* Offset of the PSM in the GAIA Debug Peer Link service record */
#define GAIA_DEBUG_PEER_LINK_SERVICE_RECORD_PSM_OFFSET              (33)

static const uint8 gaia_debug_peer_link_service_record[] =
{
   /* Offset */ /* ServiceClassIDList(0x0001), Data Element Sequence */
    /*  0 */    SDP_ATTR_ID(UUID_SERVICE_CLASS_ID_LIST),
    /*  3 */        SDP_DATA_EL_SEQ(17),

    /*  UUID Qualcomm GAIA Debug Peer Link (00001109-d102-11e1-9b23-00025b00a5a5) */
    /*  5 */        SDP_DATA_EL_UUID128(UUID_GAIA_DEBUG_PEER_LINK_SERVICE),
...
{
    *length = sizeof(gaia_debug_peer_link_service_record);
    return gaia_debug_peer_link_service_record;
}

uint16 appSdpGetGaiaDebugPeerLinkServiceRecordPsmOffset(void)
{
    return GAIA_DEBUG_PEER_LINK_SERVICE_RECORD_PSM_OFFSET;
}


/* GAIA Debug Peer Link service search request */
static const uint8 gaia_debug_peer_link_service_search_request[] =
{
    SDP_DATA_EL_SEQ(17),                     /* type = DataElSeq, 17 bytes in DataElSeq */
        SDP_DATA_EL_UUID128(UUID_GAIA_DEBUG_PEER_LINK_SERVICE),
};

const uint8 *appSdpGetGaiaDebugPeerLinkServiceSearchRequest(uint16 *length)
{
    *length = sizeof(gaia_debug_peer_link_service_search_request);
    return gaia_debug_peer_link_service_search_request;
}

/* GAIA Debug Peer Link attribute search request */
static const uint8 gaia_debug_peer_link_attribute_list[] =
{
    SDP_DATA_EL_SEQ(3),                                /* Data Element Sequence of 3 */
        SDP_ATTR_ID(UUID_PROTOCOL_DESCRIPTOR_LIST),
};
...
{
    *length = sizeof(gaia_debug_peer_link_attribute_list);
    return gaia_debug_peer_link_attribute_list;
}
