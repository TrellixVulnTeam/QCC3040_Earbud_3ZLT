...
static void twsTopology_ProcedureDisconnectPeerProfilesStopProfile(uint32 profiles)
{
    twsTopProcDisconnectPeerProfilesTaskData* td = TwsTopProcDisconnectPeerProfilesGetTaskData();
    bdaddr peer_addr;
                                        ...
                                        Message goal_data)
{
    ...
    if (   (dpp->profiles == TwsTopologyConfig_PeerProfiles())
        && (ConManagerIsConnected(&peer_addr)))
    {
...
static void twsTopology_ProcDisconnectPeerProfilesStatus(uint32 profile)
{
    twsTopProcDisconnectPeerProfilesTaskData* td = TwsTopProcDisconnectPeerProfilesGetTaskData();
