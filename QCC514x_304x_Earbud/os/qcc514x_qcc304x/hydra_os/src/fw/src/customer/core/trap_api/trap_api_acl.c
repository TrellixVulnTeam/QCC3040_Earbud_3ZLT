...
{
    IPC_ACL_ESTABLISH_COMMIT ipc_send_prim;
    IPC_BOOL_RSP ipc_recv_prim;
    ipc_send_prim.tpaddr = (const TP_BD_ADDR_T *)tpaddr;
    ipc_transaction(IPC_SIGNAL_ID_ACL_ESTABLISH_COMMIT, &ipc_send_prim, sizeof(ipc_send_prim),
                    IPC_SIGNAL_ID_ACL_ESTABLISH_COMMIT_RSP, &ipc_recv_prim);
    return ipc_recv_prim.ret;
}
