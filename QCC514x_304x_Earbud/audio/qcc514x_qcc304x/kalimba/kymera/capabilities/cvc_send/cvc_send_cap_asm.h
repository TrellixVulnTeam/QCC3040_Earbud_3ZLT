...
.CONST $cvc_send.cap.HIGH_WIND_FLAG_FIELD                73*ADDR_PER_WORD; //parms_def size is 5 words
.CONST $cvc_send.cap.HYST_FLAG_FIELD                     74*ADDR_PER_WORD;
.CONST $cvc_send.cap.PTR_MAP_RATIO                       75*ADDR_PER_WORD;
.CONST $cvc_send.cap.THREE_MIC_FLAG_FIELD                76*ADDR_PER_WORD;
