...
static const ProtobufCEnumValue reset_connection__reset_reason__enum_values_by_number[2] =
{
  { "UNKNOWN", "RESET_CONNECTION__RESET_REASON__UNKNOWN", 0 },
  { "AAP_REFUSED_MAX_CONNECTIONS_REACHED", "RESET_CONNECTION__RESET_REASON__AAP_REFUSED_MAX_CONNECTIONS_REACHED", 1 },
};
static const ProtobufCIntRange reset_connection__reset_reason__value_ranges[] = {
{0, 0},{0, 2}
};
static const ProtobufCEnumValueIndex reset_connection__reset_reason__enum_values_by_name[2] =
{
  { "AAP_REFUSED_MAX_CONNECTIONS_REACHED", 1 },
  { "UNKNOWN", 0 },
};
const ProtobufCEnumDescriptor reset_connection__reset_reason__descriptor =
{
  PROTOBUF_C__ENUM_DESCRIPTOR_MAGIC,
  "ResetConnection.ResetReason",
  "ResetReason",
  "ResetConnection__ResetReason",
  "",
  2,
  reset_connection__reset_reason__enum_values_by_number,
  2,
  reset_connection__reset_reason__enum_values_by_name,
  1,
  reset_connection__reset_reason__value_ranges,
  NULL,NULL,NULL,NULL   /* reserved[1234] */
};
static const ProtobufCFieldDescriptor reset_connection__field_descriptors[3] =
{
  {
    "timeout",
    1,
  ...
  },
  {
    ...
    0,   /* quantifier_offset */
    offsetof(ResetConnection, reset_reason),
    &reset_connection__reset_reason__descriptor,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
