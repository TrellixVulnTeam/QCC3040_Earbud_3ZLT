...
enum adcsel_enum {
         ...
         *
         * Returned value is between 0 and the result of AdcReadRequest(adcsel_vref_hq_buff)
         * which corresponds to currents between 0mA and the current requested
         * with ChargerConfigure().
         *
         * Depending on the chip absolute values can have varying accuracy,
         * application should only rely on the relative changes,
         * e.g. to track how current changes in response to ChargerConfigure()
         * request. */
        adcsel_chg_mon,
        ...
        /*! Charger voltage monitor
         *
         * Reference value for other readings, e.g. adcsel_chg_mon,
         * adcsel_pmu_vbat_sns, adcsel_pmu_vchg_sns. */
        adcsel_vref_hq_buff,
