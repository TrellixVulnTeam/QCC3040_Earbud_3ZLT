...
/*!
    \brief The Connection ID to the peer device.
*/
typedef uint16 connection_id_t;
...
/*!
    \brief This function is called to set ATT MTU for BR/EDR ATT connections.

    \param theAppTask   Application task
    \param mtu          MTU to be negotiated for ATT connections.

    \return GATT_SET_BREDR_LOCAL_MTU_CFM
*/
...
typedef struct
{
    ...
    /*! Status of the request */
    gatt_status_t status;
} GATT_SET_BREDR_LOCAL_MTU_CFM_T;
