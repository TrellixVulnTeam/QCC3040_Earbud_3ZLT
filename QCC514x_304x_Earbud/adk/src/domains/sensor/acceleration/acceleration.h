...
\brief      Header file for headset accelerometer support
            ...
            Implementation for accelerometers is in the peripherals folder, and
            may differ for each accelerometer (no common code).
*/
...
extern accelTaskData   app_accelerometer;

/*! Get pointer to the acceleromter data structure */
#define AccelerometerGetTaskData() (&app_accelerometer)
