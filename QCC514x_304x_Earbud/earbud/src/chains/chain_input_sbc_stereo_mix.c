/*!
    ...
    \file chain_input_sbc_stereo_mix.c
    \brief The chain_input_sbc_stereo_mix chain.
...
static const operator_connection_t connections[] =
{
    ...
    {OPR_SBC_DECODER, 0, OPR_LEFT_RIGHT_MIXER, 0, 1},
    {OPR_SBC_DECODER, 1, OPR_LEFT_RIGHT_MIXER, 1, 1},
} ;

const chain_config_t chain_input_sbc_stereo_mix_config_p0 = {0, 0, operators_p0, 3, inputs, 1, outputs, 1, connections, 3};

const chain_config_t chain_input_sbc_stereo_mix_config_p1 = {0, 0, operators_p1, 3, inputs, 1, outputs, 1, connections, 3};
