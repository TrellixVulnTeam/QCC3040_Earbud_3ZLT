...
enum earbud_secondary_rules_messages
{
    ...
    SEC_CONN_RULES_SEND_STATE_TO_HANDSET = END_OF_PRIMARY_CONN_RULES,
    ...
    CONN_RULES_MESSAGE_END
};
ASSERT_MESSAGE_GROUP_NOT_OVERFLOWED(CONN_RULES, CONN_RULES_MESSAGE_END)
