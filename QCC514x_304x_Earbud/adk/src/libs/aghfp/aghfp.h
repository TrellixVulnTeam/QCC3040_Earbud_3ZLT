...
typedef struct
{
    ...
    uint8               wesco;          /*!< Number of slots in the retransmission window Valid range is 0 – 254 slots Only even values are valid1*/
    uint8               tesco;          /*!< esco interval. Measured in slots*/
