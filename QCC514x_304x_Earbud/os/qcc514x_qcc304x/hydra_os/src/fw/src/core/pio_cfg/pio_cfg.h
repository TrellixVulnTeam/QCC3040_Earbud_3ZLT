...
typedef enum
{
    ...
    PIO_CFG_PAD_MUX_XTAL_MACRO_BYPASS,
    PIO_CFG_PAD_MUX_XTAL_MACRO_OBSERVE,
    PIO_CFG_PAD_MUX_AUDIO_PCM,
    PIO_CFG_PAD_MUX_MCLK_FROM_PLL,
    PIO_CFG_PAD_MUX_RESETB,
    PIO_CFG_PAD_MUX_CLK32K,
    PIO_CFG_PAD_MUX_SDIO_HOST,
    PIO_CFG_PAD_MUX_SQIF_NORMAL,
    PIO_CFG_PAD_MUX_SQIF_BT_ONLY,
    PIO_CFG_PAD_MUX_SQIF_RAM,
    PIO_CFG_PAD_MUX_SQIF_AUDIO_ONLY,
    PIO_CFG_PAD_MUX_BT_MCI_SWD
} pio_cfg_pad_mux;
...
typedef enum
{
    PIO_CFG_PIO_MUX_CURATOR     = SYSTEM_BUS_CURATOR,
    PIO_CFG_PIO_MUX_HOST        = SYSTEM_BUS_HOST_SYS,
    PIO_CFG_PIO_MUX_BT          = SYSTEM_BUS_BT_SYS,
    PIO_CFG_PIO_MUX_AUDIO       = SYSTEM_BUS_AUDIO_SYS,
    PIO_CFG_PIO_MUX_APPS        = SYSTEM_BUS_APPS_SYS,
    PIO_CFG_PIO_MUX_LED_CTRL    = SYSTEM_BUS_NUM_SUBSYSTEMS
} pio_cfg_pio_mux;
