...
#define MirrorProfile_MirrorCisCreateReq(cis_handle, cis_ownership) ((void) cis_handle, (void) cis_ownership)
#define MirrorProfile_MirrorCisDisconnectReq(conn_handle, reason) ((void) conn_handle, (void) reason)
#define MirrorProfile_HandleSetupIsoDataPathCfm(cfm) ((void) cfm)
#define MirrorProfile_HandleRemoveIsoDataPathCfm(cfm) ((void) cfm)
