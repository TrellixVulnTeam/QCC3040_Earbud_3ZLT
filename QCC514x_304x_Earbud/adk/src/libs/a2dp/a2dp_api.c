...
static uint8 findDeviceId (remote_device *device)
{
    ...
    {
        DEBUG_LOG_V_VERBOSE("findDeviceId %u",device->bitfields.device_id);
        return device->bitfields.device_id;
    }

    DEBUG_LOG_WARN("findDeviceId INVALID_DEVICE_ID");
...
static uint8 findStreamId (media_channel *media)
{
    ...
    {
        DEBUG_LOG_V_VERBOSE("findStreamId %u",media->status.conn_info.media_id);
        return media->status.conn_info.media_id;
    }

    DEBUG_LOG_WARN("findStreamId INVALID_STREAM_ID");
...
void a2dpSignallingConnectInd (remote_device *device)
{
    ...
    DEBUG_LOG_FN_ENTRY("a2dpSignallingConnectInd sending");
...
void a2dpSignallingConnectCfm (remote_device *device, a2dp_status_code status)
{
    ...
    DEBUG_LOG_FN_ENTRY("a2dpSignallingConnectCfm sending enum:a2dp_status_code:%d", status);
...
void a2dpSignallingDisconnectInd (remote_device *device, a2dp_status_code status)
{
    ...
    DEBUG_LOG_FN_ENTRY("a2dpSignallingDisconnectInd sending enum:a2dp_status_code:%d", status);
...
void a2dpSignallingLinklossInd (remote_device *device)
{
    ...
    DEBUG_LOG_FN_ENTRY("a2dpSignallingLinklossInd sending");
...
void a2dpLinklossReconnectCancelledInd (remote_device *device)
{
    ...
    DEBUG_LOG_FN_ENTRY("a2dpLinklossReconnectCancelledInd sending");
...
void a2dpMediaOpenInd (remote_device *device, uint8 seid)
{
    ...
    DEBUG_LOG_FN_ENTRY("a2dpMediaOpenInd sending");
...
void a2dpMediaOpenCfm (remote_device *device, media_channel *media, a2dp_status_code status)
{
    ...
    DEBUG_LOG_FN_ENTRY("a2dpMediaOpenCfm sending enum:a2dp_status_code:%d", status);
...
void a2dpMediaCloseInd (remote_device *device, media_channel *media, a2dp_status_code status)
{
    ...
    DEBUG_LOG_FN_ENTRY("a2dpMediaCloseInd sending enum:a2dp_status_code:%d", status);
...
void a2dpMediaStartInd (remote_device *device, media_channel *media)
{
    ...
    DEBUG_LOG_FN_ENTRY("a2dpMediaStartInd sending");
...
void a2dpMediaStartCfm (remote_device *device, media_channel *media, a2dp_status_code status)
{
    ...
    DEBUG_LOG_FN_ENTRY("a2dpMediaStartCfm sending enum:a2dp_status_code:%d", status);
...
void a2dpMediaSuspendInd (remote_device *device, media_channel *media)
{
    ...
    DEBUG_LOG_FN_ENTRY("a2dpMediaSuspendInd sending");
...
void a2dpMediaSuspendCfm (remote_device *device, media_channel *media, a2dp_status_code status)
{
    ...
    DEBUG_LOG_FN_ENTRY("a2dpMediaSuspendCfm sending enum:a2dp_status_code:%d", status);
...
void a2dpCodecConfigureInd (remote_device *device, uint8 local_seid, uint16 size_remote_service_caps, const uint8* remote_service_caps)
{
    ...
    DEBUG_LOG_FN_ENTRY("a2dpCodecConfigureInd local_seid %u", local_seid);
...
void a2dpMediaReconfigureInd (remote_device *device, media_channel *media)
{
    ...
    DEBUG_LOG_FN_ENTRY("a2dpMediaReconfigureInd sending");
...
void a2dpMediaReconfigureCfm (remote_device *device, media_channel *media, a2dp_status_code status)
{
    ...
    DEBUG_LOG_FN_ENTRY("a2dpMediaReconfigureCfm sending");
...
void a2dpMediaAvSyncDelayInd (remote_device *device, uint8 seid)
{
    ...
    DEBUG_LOG_FN_ENTRY("a2dpMediaAvSyncDelayInd sending");
...
void a2dpMediaAvSyncDelayCfm (remote_device *device, uint8 seid, a2dp_status_code status)
{
    ...
    DEBUG_LOG_FN_ENTRY("a2dpMediaAvSyncDelayCfm sending");
...
void a2dpMediaAvSyncDelayUpdatedInd (remote_device *device, uint8 seid, uint16 delay)
{
    ...
    DEBUG_LOG_FN_ENTRY("a2dpMediaAvSyncDelayUpdatedInd sending");
...
bool A2dpSignallingSetLargeMTU(const bdaddr *addr, bool use_large_mtu)
{
    if ((a2dp == NULL) || (addr == NULL) || BdaddrIsZero(addr))
    {
        return FALSE;
    ...
    {
        MAKE_A2DP_MESSAGE(A2DP_INTERNAL_SIGNALLING_MTU_REQ);
        message->addr = *addr;
        message->use_large_mtu = use_large_mtu;
        MessageSend(&a2dp->task, A2DP_INTERNAL_SIGNALLING_MTU_REQ, message);
        return TRUE;
    }
}
...
bool A2dpMediaOpenRequest (uint8 device_id, uint16 size_seid_list, const uint8 *seid_list)
{
    if ((a2dp == NULL) || (device_id >= A2DP_MAX_REMOTE_DEVICES))
    {
        return FALSE;
...
void A2dpGetCurrentSepCapabilities(A2DP *dep_a2dp)
{
        ...
        )
    {
        ...
        {
            /* Start watchdog */
            DEBUG_LOG("A2dpGetCurrentSepCapabilities seid %d",a2dp->sep.remote_seid);
