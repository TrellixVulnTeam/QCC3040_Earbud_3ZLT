...
typedef struct _DeviceInformation__MetadataEntry DeviceInformation__MetadataEntry;
...
struct  _DeviceInformation__MetadataEntry
{
  ProtobufCMessage base;
  char *key;
  char *value;
};
#define DEVICE_INFORMATION__METADATA_ENTRY__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&device_information__metadata_entry__descriptor) \
...
struct  _DeviceInformation
{
  ...
  size_t n_metadata;
  DeviceInformation__MetadataEntry **metadata;
};
#define DEVICE_INFORMATION__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&device_information__descriptor) \
    , (char *)protobuf_c_empty_string, (char *)protobuf_c_empty_string, 0,NULL, (char *)protobuf_c_empty_string, 0, NULL, NULL, 0, 0,NULL, 0,NULL, 0,NULL, 0,NULL }
...
void   device_status__free_unpacked
                     (DeviceStatus *message,
                      ProtobufCAllocator *allocator);
/* DeviceInformation__MetadataEntry methods */
...
typedef void (*DeviceStatus_Closure)
                 (const DeviceStatus *message,
                  void *closure_data);
typedef void (*DeviceInformation__MetadataEntry_Closure)
                 (const DeviceInformation__MetadataEntry *message,
                  void *closure_data);
...
extern const ProtobufCMessageDescriptor device_information__metadata_entry__descriptor;
