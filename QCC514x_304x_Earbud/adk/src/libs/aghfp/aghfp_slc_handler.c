...
/****************************************************************************
    Set if the SLC connection has been initiated locally or by the remote
    device.
*/
void aghfpSlcLocallyInitiated(AGHFP *aghfp, bool local_initiator)
{
    aghfp->slc_connecting_initiated_locally = local_initiator;
}

/****************************************************************************
    Get bool represeting if the SLC connection has been initiated locally
    or by the remote device. TRUE is locally initiated and FALSE is remote
    initiated.
*/
bool aghfpIsSlcLocallyInitiated(AGHFP *aghfp)
{
    return aghfp->slc_connecting_initiated_locally;
}
...
{
    /* Set as a locally initiated SLC connection */
    aghfpSlcLocallyInitiated(aghfp, TRUE);
