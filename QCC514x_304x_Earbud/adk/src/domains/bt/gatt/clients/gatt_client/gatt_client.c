...
bool GattClient_AttachClient(client_id_t client_id, gatt_cid_t cid, uint16 start_handle, uint16 end_handle)
{
    bool status = FALSE;
...
bool GattClient_DetachClient(client_id_t client_id, gatt_cid_t cid)
{
    bool status = FALSE;
