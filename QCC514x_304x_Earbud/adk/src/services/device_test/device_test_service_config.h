...
/*! Channel for RFComm that will be requested for the SPP channel.
    ...
    The Bluetooth library will allocate the actual channel used.
    This is allowed to be different from that requested.
 */
#define DeviceTestService_RecommendedSppRfcommChannel() 25


/*! The PSKEY to use to determine if Device Test Mode is enabled
 */
#define DeviceTestService_EnablingPskey() PS_KEY_DTS_ENABLE
