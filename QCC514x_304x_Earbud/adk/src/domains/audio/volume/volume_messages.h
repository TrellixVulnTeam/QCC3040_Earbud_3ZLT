...
typedef struct
{
    ...
    event_origin_t origin;
    bool mute_state;
} voice_source_mute_volume_request_message_t;
...
typedef struct
{
    ...
    event_origin_t origin;
    bool mute_state;
} audio_source_mute_volume_request_message_t;
...
/*! \brief Request to mute the audio output.
    ...
    \param source The source mute to update
    \param origin The origin of the mute update request
