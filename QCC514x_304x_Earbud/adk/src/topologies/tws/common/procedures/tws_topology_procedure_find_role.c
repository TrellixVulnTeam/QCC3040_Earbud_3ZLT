                                        ...
                                        Message goal_data)
{
    ...
    /* Guard against starting PFR when already active, which can happen if multiple rules generate the goal
       to find role. If PFR is already active then the intention of starting this goal will be met when it
       completes, so complete this instance of the procedure immediately */
