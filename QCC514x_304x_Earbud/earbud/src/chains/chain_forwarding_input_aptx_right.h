...
/*!
\page chain_forwarding_input_aptx_right
    @startuml
...
extern const chain_config_t chain_forwarding_input_aptx_right_config_p0;

extern const chain_config_t chain_forwarding_input_aptx_right_config_p1;
