...
/* Inquiry scan messages must be numbered greater than equivalent page scan message
   in the enum bredr_scan_manager_messages. */
#define PAGE_SCAN_MESSAGE_OFFSET (0)
#define INQ_SCAN_MESSAGE_OFFSET (PAGE_SCAN_MESSAGE_OFFSET + 1)
...
enum bredr_scan_manager_messages
{
    ...
    BREDR_SCAN_MANAGER_INQUIRY_SCAN_PAUSED_IND = BREDR_SCAN_MANAGER_PAGE_SCAN_PAUSED_IND + INQ_SCAN_MESSAGE_OFFSET,
    ...
    BREDR_SCAN_MANAGER_INQUIRY_SCAN_RESUMED_IND = BREDR_SCAN_MANAGER_PAGE_SCAN_RESUMED_IND + INQ_SCAN_MESSAGE_OFFSET,
    ...
    /*! Indication of page scan activity is throttled - other higher priority features are running in system */
    BREDR_SCAN_MANAGER_PAGE_SCAN_THROTTLED_IND,

    /*! Indication of page scan activity is unthrottled - other higher priority features are stopped running in system */
    BREDR_SCAN_MANAGER_PAGE_SCAN_UNTHROTTLED_IND,

    /*! This must be the final message */
    BREDR_SCAN_MANAGER_MESSAGE_END
};
...
typedef enum
{
    ...
    /*! Throttle parameters type, balanced duty cycle */
    SCAN_MAN_PARAMS_TYPE_THROTTLE,

    /*! Always the largest acceptable type */
    SCAN_MAN_PARAMS_TYPE_MAX = SCAN_MAN_PARAMS_TYPE_THROTTLE,
...
/*! \brief API causes page scan feature callback to be called */
