...
#define HCI_ULP_ACCEPT_CIS                                ((hci_op_code_t)HCI_ULP | 0x0066)
#define HCI_ULP_REJECT_CIS                                ((hci_op_code_t)HCI_ULP | 0x0067)
...
#define HCI_MAX_ULP_OCF                                   ((hci_op_code_t)0x007F)
...
#define HCI_ULP_SET_CIG_PARAMETERS_PARAM_TEST_LEN                   ((uint8_t) 15) /* Variable */
#define HCI_ULP_REMOVE_CIG_PARAM_LEN                                ((uint8_t)  1)
#define HCI_ULP_CREATE_CIS_PARAM_LEN                                ((uint8_t)  5) /* Variable */
#define HCI_ULP_ACCEPT_CIS_PARAM_LEN                                ((uint8_t)  2)
#define HCI_ULP_REJECT_CIS_PARAM_LEN                                ((uint8_t)  3)
...
#define HCI_ULP_ISO_TRANSMIT_PARAM_LEN                              ((uint8_t)  3)
#define HCI_ULP_ISO_RECEIVE_PARAM_LEN                               ((uint8_t)  3)
...
#define HCI_ULP_REJECT_CIS_ARG_LEN                                ((uint8_t)  6)
...
#define HCI_VER_MAX    HCI_VER_5_2 /* Latest supported HCI version */
...
#define HCI_ULP_MAX_ENABLE_ADV_SETS                 5
 ...
 *
 *----------------------------------------------------------------------------*/
/* Bit values for options field */
#define HCI_ULP_OPTION_PERIODIC_ADVERTISER_LIST 1
#define HCI_ULP_OPTION_DISABLE_PERIODIC_REPORTS 2
...
typedef struct
{
    ...
    hci_connection_handle_t    cis_handle;
    uint8_t                    reason;
}HCI_ULP_REJECT_CIS_T;

typedef struct
{
    hci_connection_handle_t    cis_handle;
}HCI_ULP_REJECT_CIS_RET_T;
...
typedef union
{
    ...
    HCI_ULP_REJECT_CIS_RET_T                                hci_ulp_reject_cis_args;
...
typedef union hci_uprim_tag
{
    ...
    HCI_ULP_ACCEPT_CIS_T                                hci_ulp_accept_cis;
    HCI_ULP_REJECT_CIS_T                                hci_ulp_reject_cis;
