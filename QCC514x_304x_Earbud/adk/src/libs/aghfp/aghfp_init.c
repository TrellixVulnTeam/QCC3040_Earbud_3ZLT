/****************************************************************************
Copyright (c) 2005 - 2021 Qualcomm Technologies International, Ltd.
...
LOGGING_PRESERVE_MESSAGE_TYPE(AghfpMessageId)
        ...
        )
{
    ...
    /* Check if AGHFP was initiated with unsupported features */
    if ( supported_features & (aghfp_enhanced_voice_recognition_status |
                               aghfp_voice_recognition_text) )
    {
        Panic();
    }
