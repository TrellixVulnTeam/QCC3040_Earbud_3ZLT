...
/*! \brief Checks if device is on the device list.

    \param device The device to be found to the list.

    \return TRUE If device is present on the list.
*/
...
/*! \brief Find all the devices in the list which have a specified property.

    This function is similar to DeviceList_GetAllDevicesWithPropertyValue,
    but it the value of property doesn't matter.
