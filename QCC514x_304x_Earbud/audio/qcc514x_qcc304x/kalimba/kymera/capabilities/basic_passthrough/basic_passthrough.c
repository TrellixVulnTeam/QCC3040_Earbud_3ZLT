...
const opmsg_handler_lookup_table_entry ttp_passthrough_opmsg_handler_table[] =
    ...
    {OPMSG_COMMON_ID_SET_UCID,                     basic_passthrough_opmsg_set_ucid},
    {OPMSG_COMMON_ID_GET_LOGICAL_PS_ID,            basic_passthrough_opmsg_get_ps_id},
    {OPMSG_COMMON_RESYNC_TTP,                      ttp_passthrough_opmsg_resync_ttp},
    {OPMSG_PEQ_ID_LOAD_CONFIG,                     basic_passthrough_opmsg_load_config},
    {0, NULL}};
...
bool ttp_passthrough_opmsg_resync_ttp(OPERATOR_DATA *op_data, void *message_data, unsigned *resp_length, OP_OPMSG_RSP_PAYLOAD **resp_data)
{
    BASIC_PASSTHROUGH_OP_DATA *opx_data = get_instance_data(op_data);

    ttp_reset(opx_data->time_to_play);
    return TRUE;
}
