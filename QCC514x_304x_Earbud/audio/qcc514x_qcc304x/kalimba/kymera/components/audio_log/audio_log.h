...
#else
#define L3_DBG_MSG(x)                 (void)0
#define L3_DBG_MSG1(x, a)             (void)0
#define L3_DBG_MSG2(x, a, b)          (void)0
#define L3_DBG_MSG3(x, a, b, c)       (void)0
#define L3_DBG_MSG4(x, a, b, c, d)    (void)0
#define L3_DBG_MSG5(x, a, b, c, d, e) (void)0
#endif /* INSTALL_LOG_LEVEL_3 */

/**
 * Log minor module level event.
 */
#ifdef INSTALL_LOG_LEVEL_4
...
#else
#define L4_DBG_MSG(x)                 (void)0
#define L4_DBG_MSG1(x, a)             (void)0
#define L4_DBG_MSG2(x, a, b)          (void)0
#define L4_DBG_MSG3(x, a, b, c)       (void)0
#define L4_DBG_MSG4(x, a, b, c, d)    (void)0
#define L4_DBG_MSG5(x, a, b, c, d, e) (void)0
#endif /* INSTALL_LOG_LEVEL_4 */

/**
 * Log minutiae
 */
#ifdef INSTALL_LOG_LEVEL_5
...
#else
#define L5_DBG_MSG(x)                 (void)0
#define L5_DBG_MSG1(x, a)             (void)0
#define L5_DBG_MSG2(x, a, b)          (void)0
#define L5_DBG_MSG3(x, a, b, c)       (void)0
#define L5_DBG_MSG4(x, a, b, c, d)    (void)0
#define L5_DBG_MSG5(x, a, b, c, d, e) (void)0
#endif /* INSTALL_LOG_LEVEL_5 */
