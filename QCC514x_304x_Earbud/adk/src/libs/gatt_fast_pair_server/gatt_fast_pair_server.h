...
#define FAST_PAIR_DATA_PKT_SIZE_MIN (16)
...
/*! @brief Model ID characteristic value data. This characteristic can ONLY be read.
 */
typedef struct __GATT_FAST_PAIR_SERVER_READ_MODEL_ID_IND_T
{
    const GFPS  *fast_pair_server;
    uint16      cid;
}GATT_FAST_PAIR_SERVER_READ_MODEL_ID_IND_T;

/*! @brief Firmware Revision characteristic value data. This characteristic can ONLY be read.
 */
typedef struct __GATT_FAST_PAIR_SERVER_READ_FIRMWARE_REVISION_IND_T
{
    const GFPS  *fast_pair_server;
    uint16      cid;
}GATT_FAST_PAIR_SERVER_READ_FIRMWARE_REVISION_IND_T;
...
/*! @brief Data characteristic Client Configuration attribute
    value, when configured by the client.
 */
typedef GATT_FAST_PAIR_SERVER_WRITE_KEYBASED_PAIRING_CONFIG_IND_T
            GATT_FAST_PAIR_SERVER_WRITE_DATA_CONFIG_IND_T;
...
/*! @brief Data characteristic value data, when written by a
    client.
 */
typedef GATT_FAST_PAIR_SERVER_WRITE_KEYBASED_PAIRING_IND_T
            GATT_FAST_PAIR_SERVER_WRITE_DATA_IND_T;
...
/*! @Brief Data notification confirmation.
 */
typedef struct GATT_FAST_PAIR_SERVER_KEYBASED_PAIRING_NOTIFICATION_CFM_T
    GATT_FAST_PAIR_SERVER_DATA_NOTIFICATION_CFM_T;
...
typedef enum {
    ...
    GATT_FAST_PAIR_SERVER_READ_FIRMWARE_REVISION_IND,
    ...
    GATT_FAST_PAIR_SERVER_DATA_NOTIFICATION_CFM,
...
/*! @brief Response to GATT_FAST_PAIR_SERVER_READ_MODEL_ID_IND_T.

    Response to the Model ID read indication.

    @param fast_pair_server Pointer to the server data.
    @param cid Connection identifier of the client.
    @param model_id The value of model id being used by the application.
...
/*! @brief Response to GATT_FAST_PAIR_SERVER_READ_FIRMWARE_REVISION_IND_T.

    Response to the Firmware Revision read indication.

    @param fast_pair_server Pointer to the server data.
    @param cid Connection identifier of the client.
    @param fw_revision_string The value of firmware revision string.
...
/*! @brief Response to GATT_FAST_PAIR_SERVER_WRITE_DATA_CONFIG_IND_T

    Response to the Data Client Configuration write indication.
...
/*! @brief Response to GATT_FAST_PAIR_SERVER_WRITE_DATA_IND_T.
...
/*! @brief Notify the Additional Data value to the client.

    The value notified is of variable length. Notification is only to one connected
    client at a time.

    @param fast_pair_server Pointer to the server data.
    @param cid Connection identifier of the client.
    @param value Additional data to notify.
