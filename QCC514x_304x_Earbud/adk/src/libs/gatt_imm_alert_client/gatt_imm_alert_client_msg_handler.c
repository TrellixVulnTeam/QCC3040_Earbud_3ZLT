...
static void handle_imm_alert_client_gatt_manager_msg(Task task, MessageId id, Message msg)
{
    ...
    GATT_IMM_ALERT_CLIENT_DEBUG_INFO(("handle_imm_alert_client_gatt_manager_msg MESSAGE:0x%x\n", id));
...
static void handle_imm_alert_ext_message(MessageId id)
{
    ...
    GATT_IMM_ALERT_CLIENT_DEBUG_PANIC(("Unknown Message received from GATT lib MESSAGE:0x%x\n",id));
}
...
static void  handle_imm_alert_internal_message(Task task, MessageId id, Message msg)
{
    ...
    GATT_IMM_ALERT_CLIENT_DEBUG_INFO(("handle_imm_alert_internal_messge MESSAGE:imm_alert_client_internal_msg_t:0x%x\n",
                                     id));
...
{
    GATT_IMM_ALERT_CLIENT_DEBUG_INFO(("imm_alert_client_msg_handler MESSAGE:imm_alert_client_internal_msg_t:0x%x\n", id));
