...
DEFINE_RULE_FUNCTION(ruleTwsTopPriShutDown);
...
DEFINE_RULE_FUNCTION(ruleTwsTopPriDisconnectPeerProfiles);
...
DEFINE_RULE_FUNCTION(ruleTwsTopPriUserRequestConnectHandset);
...
DEFINE_RULE_FUNCTION(ruleTwsTopPriInCaseWatchdogStart);
DEFINE_RULE_FUNCTION(ruleTwsTopPriOutOfCaseWatchdogStop);

DEFINE_RULE_FUNCTION(ruleTwsTopPriDisconnectLruHandset);
/*! \} */
