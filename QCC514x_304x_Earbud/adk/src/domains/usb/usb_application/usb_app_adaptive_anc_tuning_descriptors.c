...
\file       usb_common.c
\brief      USB Audio class 1.0 descriptors for Adaptive ANC tuning application.
*/
...
#define USB_AUDIO_SAMPLE_RATE      SAMPLE_RATE_16K

#define AUDIO_MIC_CHANNELS         2
#define AUDIO_SPKR_CHANNELS        1
...
static const uint8 control_intf_desc_audio_mic[] =
{
    ...
    UAC_TRM_INPUT_PERS_MIC & 0xFF,      /* wTerminalType = Microphone */
    UAC_TRM_INPUT_PERS_MIC >> 8,
...
static const uint8 control_intf_desc_audio_spkr[] =
{
    ...
    FU_DESC_CONTROL_SIZE,               /* bControlSize = 1 bytes per control*/
    UAC_FU_CONTROL_MUTE,              /* bmaControls[0] (Master Channel - mute) */
    UAC_FU_CONTROL_UNDEFINED,           /* bmaControls[1] (Logical Channel 1 - nothing) */
    #if AUDIO_SPKR_CHANNELS == 2
    UAC_FU_CONTROL_UNDEFINED,           /* bmaControls[2] (Logical Channel 2 - nothing) */
    #endif
...
static const uint8 streaming_intf_desc_audio_mic[] =
{
    ...
    USB_AUDIO_SAMPLE_RATE & 0xFF,             /* tSampleFreq = 16000*/
...
static const uac_control_config_t adaptive_anc_tuning_control_mic_desc = {
    control_intf_desc_audio_mic,
    sizeof(control_intf_desc_audio_mic)
};

static const uac_streaming_config_t adaptive_anc_tuning_streaming_mic_desc = {
    streaming_intf_desc_audio_mic,
    sizeof(streaming_intf_desc_audio_mic)
};

static const uac_endpoint_config_t adaptive_anc_tuning_mic_endpoint = {
    .is_to_host = 1,
    .wMaxPacketSize = 0,
    .bInterval = 1
};
...
/* Audio Speaker interface descriptors */
static const uac_control_config_t adaptive_anc_tuning_control_spkr_desc = {
    control_intf_desc_audio_spkr,
    sizeof(control_intf_desc_audio_spkr)
};

static const uac_streaming_config_t adaptive_anc_tuning_streaming_spkr_desc = {
    streaming_intf_desc_audio_spkr,
    sizeof(streaming_intf_desc_audio_spkr)
};

static const uac_endpoint_config_t adaptive_anc_tuning_spkr_endpoint = {
    .is_to_host = 0,
    .wMaxPacketSize = 0,
    .bInterval = 1
};

static const usb_audio_interface_config_t adaptive_anc_tuning_intf_list[] =
{
    {
        .type = USB_AUDIO_DEVICE_TYPE_AUDIO_SPEAKER,
        .control_desc =   &adaptive_anc_tuning_control_spkr_desc,
        .streaming_desc = &adaptive_anc_tuning_streaming_spkr_desc,
        .endpoint =       &adaptive_anc_tuning_spkr_endpoint
    },
    {
        .type = USB_AUDIO_DEVICE_TYPE_AUDIO_MIC,
        .control_desc =   &adaptive_anc_tuning_control_mic_desc,
        .streaming_desc = &adaptive_anc_tuning_streaming_mic_desc,
        .endpoint =       &adaptive_anc_tuning_mic_endpoint
    }
};

const usb_audio_interface_config_list_t adaptive_anc_tuning_interfaces =
{
    .intf = adaptive_anc_tuning_intf_list,
    .num_interfaces = ARRAY_DIM(adaptive_anc_tuning_intf_list)
};
