...
const opmsg_handler_lookup_table_entry rtp_decode_opmsg_handler_table[] =
    ...
    {OPMSG_COMMON_SET_TTP_STATE,                 rtp_decode_opmsg_set_ttp_state},
    ...
    {OPMSG_COMMON_SET_TTP_SPADJ,                 rtp_decode_opmsg_set_sp_adjustment},
    {OPMSG_COMMON_ADJUST_TTP_TIMESTAMP,          rtp_decode_opmsg_adjust_ttp_timestamp},
    ...
    {OPMSG_RTP_DECODE_ID_SET_TTP_NOTIFICATION,   rtp_decode_opmsg_set_ttp_notification},
    {OPMSG_COMMON_RESYNC_TTP,                    rtp_decode_opmsg_resync_ttp},
    {0, NULL}};
