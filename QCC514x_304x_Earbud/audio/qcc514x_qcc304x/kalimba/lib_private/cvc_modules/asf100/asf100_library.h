...
#include "../../../lib/portability/portability_macros.h"
#endif
...
.CONST $asf100.BEAM0_MODE_FIELD                13*ADDR_PER_WORD;

// @DOC_FIELD_TEXT Beam_mode = 0 -> Fixed Delay and Sum Beamforming
// @DOC_FIELD_TEXT           = 1 -> Adaptive MVDR Beamforming
// @DOC_FIELD_FORMAT Integer
.CONST $asf100.BEAM1_MODE_FIELD                14*ADDR_PER_WORD;

// Start frequency objects (X0/X1)
.CONST $asf100.X0_FREQ_OBJ                     15*ADDR_PER_WORD;
.CONST $asf100.X1_FREQ_OBJ                     16*ADDR_PER_WORD;
...
.CONST $asf100.bf.SCRATCH_X0_TMP_BUF_FREQ_OBJ  17*ADDR_PER_WORD;
.CONST $asf100.bf.SCRATCH_X1_TMP_BUF_FREQ_OBJ  18*ADDR_PER_WORD;
//save X0 
.CONST $asf100.bf.X0_SAVED_FREQ_OBJ            19*ADDR_PER_WORD;
//save X1
.CONST $asf100.bf.X1_SAVED_FREQ_OBJ            20*ADDR_PER_WORD;
//Z0_aux
.CONST $asf100.bf.Z0_AUX_FREQ_OBJ              21*ADDR_PER_WORD;
//Z1_aux
.CONST $asf100.bf.Z1_AUX_FREQ_OBJ              22*ADDR_PER_WORD;
.CONST $asf100.WIND_FLAG_PTR                   23*ADDR_PER_WORD;
.CONST $asf100.INTERNAL_START_FIELD            24*ADDR_PER_WORD;
...
.CONST $asf100.WNR_MAP_FLAG_FIELD            ADDR_PER_WORD + $asf100.BF_END_FIELD;
.CONST $asf100.WNR_HIGH_WIND_FLAG_FIELD      ADDR_PER_WORD + $asf100.WNR_MAP_FLAG_FIELD;
.CONST $asf100.WNR.HI_THRESH_SILENCE_FIELD   ADDR_PER_WORD + $asf100.WNR_HIGH_WIND_FLAG_FIELD;
.CONST $asf100.WNR.HI_WIND_PARAM_FIELD       ADDR_PER_WORD + $asf100.WNR.HI_THRESH_SILENCE_FIELD;
...
// @DOC_FIELD_TEXT      High Wind Silence Threshold, in log2 dB.
// @DOC_FIELD_TEXT      Signal will be treated as non-wind silence if power is below this threshold.
// @DOC_FIELD_FORMAT    Q8.16 format (arch4: q8.24)
.CONST $asf100.wnr.param.HI_THRESH_PHASE_FIELD   0*ADDR_PER_WORD;

// @DOC_FIELD_TEXT      High Wind Noise Reduction Phase Threshold. Range is 0 to 1.0
// @DOC_FIELD_FORMAT    Q1.23 format (arch4: q1.31)
.CONST $asf100.wnr.param.HI_THRESH_COHERENCE_FIELD 1*ADDR_PER_WORD;

// @DOC_FIELD_TEXT      High Wind Noise Reduction Coherence Threshold. Range is 0 to 1.0
// @DOC_FIELD_FORMAT    Q1.23 format (arch4: q1.31)
.CONST $asf100.wnr.param.HI_WNR_WIND_POW_TH_FIELD 2*ADDR_PER_WORD;
