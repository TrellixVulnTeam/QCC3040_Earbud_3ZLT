...
#ifdef CVC_INEAR_STREPLUS_ROM_HARDWARE_BUILD
...
.CONST $aec520.HS.Num_Primary_Taps           2;
.CONST $aec520.HS.Num_Auxillary_Taps         1;
...
.CONST $aec520.HS_UWB.Num_Auxillary_Taps     1;

.CONST $aec520.RER_DIM                       64;
.CONST $aec520.RER_DIM.UWB                   43;
.CONST $aec520.PLAY_BACK_TH                  0xEC1184B9; // -60 dB in log2() in q.24
...
.CONST $aec520.FUNC_DTC_USER                 $aec520.FLAG_BYPASS_FBC_FIELD + ADDR_PER_WORD;
.CONST $aec520.DTC_dim                       $aec520.FUNC_DTC_USER + ADDR_PER_WORD;
.CONST $aec520.FLAG_BYPASS_AUX_FIELD         $aec520.DTC_dim + ADDR_PER_WORD;
.CONST $aec520.REF_FIELD                     $aec520.FLAG_BYPASS_AUX_FIELD + ADDR_PER_WORD;
.CONST $aec520.REF_POWER_FIELD               $aec520.REF_FIELD + ADDR_PER_WORD;
.CONST $aec520.PTR_LOW_INPUT_FIELD           $aec520.REF_POWER_FIELD + ADDR_PER_WORD;

.CONST $aec520.STRUCT_SIZE                  ($aec520.FLAG_BYPASS_FBC_FIELD >> LOG2_ADDR_PER_WORD) + 1; //Keep legacy STRUCT_SIZE to avoid rom conflict 
...
// Shared fields
// -----------------------------------------------------------------------------
#define $aec520.map.SELFCLEAN_PTR_FIELD           $aec520.X_STREAM_FIELD
