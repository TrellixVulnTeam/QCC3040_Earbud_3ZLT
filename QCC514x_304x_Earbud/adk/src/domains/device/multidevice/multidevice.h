...
/*! \brief Get the side of pair device.

    \return Side of a pair device.
*/
...
/*! \brief Check if device type is multidevice_type_pair.

    \returns TRUE if device type is multidevice_type_pair otherwise FALSE.
*/
