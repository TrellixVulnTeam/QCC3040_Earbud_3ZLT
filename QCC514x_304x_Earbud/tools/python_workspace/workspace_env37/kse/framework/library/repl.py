...
#
"""KATS framework Read Evaluate Print Loop utilities"""
...
def launch_repl(repl, namespace, *args, **kwargs):
    ...
    extra_banner = kwargs.pop('extra_banner', None)
    if extra_banner:
