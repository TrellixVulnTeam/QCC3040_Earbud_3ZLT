...
#include "aac_decode/aac_decode.h"
    ...
    defined(INSTALL_OPERATOR_CVC_EARBUD_2MIC_IE) || \
    defined(INSTALL_OPERATOR_CVC_EARBUD_3MIC_MONO_IE)
...
#if defined(INSTALL_OPERATOR_AANC_MONO_16K)
#include "aanc/aanc.h"
#endif

#if defined(INSTALL_OPERATOR_AANC_LITE_16K)
#include "aanc_lite/aanc_lite.h"
#endif

#if defined(INSTALL_OPERATOR_EARBUD_FIT_TEST_16K)
#include "earbud_fit_test/earbud_fit_test.h"
#endif
...
const CAPABILITY_DATA* const capability_data_table[] = {
   ...
   &xover_cap_data,
    ...
    &cvc_send_earbud_2mic_wb_ie_cap_data,
    &cvc_send_earbud_2mic_nb_ie_cap_data,
#endif
#ifdef INSTALL_OPERATOR_CVC_EARBUD_3MIC_MONO_IE
    &cvc_send_earbud_3mic_mono_ie_cap_data,
    &cvc_send_earbud_3mic_mono_nb_ie_cap_data,
#endif    
...
&rate_adjust_cap_data,
   ...
   &source_sync_cap_data,
    ...
    &aanc_mono_16k_cap_data,
#endif
#ifdef INSTALL_OPERATOR_AANC_LITE_16K
    &aanc_lite_16k_cap_data,
#endif

#ifdef INSTALL_OPERATOR_EARBUD_FIT_TEST_16K
    &earbud_fit_test_16k_cap_data,
#endif
