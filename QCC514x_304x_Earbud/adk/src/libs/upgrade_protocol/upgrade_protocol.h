...
*/
#ifndef UPGRADE_PROTOCOL_H_
#define UPGRADE_PROTOCOL_H_
...
/* Sent by host
   ...
   UPGRADE_HOST_SILENT_COMMIT_SUPPORTED_REQ
 */
...
/* Sent by device
   ...
   UPGRADE_HOST_SILENT_COMMIT_SUPPORTED_CFM
   UPGRADE_HOST_SILENT_COMMIT_CFM
 */
...
typedef enum {
    ...
    UPGRADE_HOST_ERROR_HANDOVER_DFU_ABORT,
...
#define UPGRADE_HOST_DATA_MIN_BYTE_SIZE (1)
...
#define UPGRADE_HOST_TRANSFER_COMPLETE_RES_BYTE_SIZE (1)

typedef UPGRADE_HOST_GENERIC_ACTION_T UPGRADE_HOST_IN_PROGRESS_RES_T;
#define UPGRADE_HOST_IN_PROGRESS_RES_BYTE_SIZE (1)
...
#define UPGRADE_HOST_VERSION_CFM_BYTE_SIZE (6) /*!< Number of payload bytes in a UPGRADE_VERSION_CFM protocol message */
...
#define UPGRADE_HOST_VARIANT_CFM_BYTE_SIZE (8) /*!< Number of payload bytes in an UPGRADE_VARIANT_CFM protocol message */

/*!
    Definition of the UPGRADE_HOST_SILENT_COMMIT_SUPPORTED_CFM message.
    Sent by the device to the host in response to the
    UPGRADE_HOST_SILENT_COMMIT_SUPPORTED_REQ message.
 */
typedef struct {
    uint8 is_silent_commit_supported;
} UPGRADE_HOST_SILENT_COMMIT_SUPPORTED_CFM_T;
#define UPGRADE_HOST_SILENT_COMMIT_SUPPORTED_CFM_BYTE_SIZE (1)

#endif /* UPGRADE_PROTOCOL_H_ */
