...
// File name  : /home/jl56/chips__jl56_auraplus2/auraplus/d00/results/apps_sys/regs/asm/io_map.asm
// Creator    : GenKalimbaAsm.pm
// Timestamp  : Mon Oct  8 10:30:28 BST 2018
//
...
.CONST $HOST_SYS_SCALED_CLK_VETO_EN          0x6004D084; // RW   5 bits
.CONST $_HOST_SYS_SCALED_CLK_VETO_EN         $HOST_SYS_SCALED_CLK_VETO_EN; // RW   5 bits
.CONST $HOST_SYS_SPI_ENABLES                 0x6004D088; // RW   2 bits
.CONST $_HOST_SYS_SPI_ENABLES                $HOST_SYS_SPI_ENABLES; // RW   2 bits
...
.CONST $USB_TX_PREFETCH_RAM_0_TO_3_WABL      0x6004D09C; // RW  12 bits
.CONST $_USB_TX_PREFETCH_RAM_0_TO_3_WABL     $USB_TX_PREFETCH_RAM_0_TO_3_WABL; // RW  12 bits
.CONST $USB_TX_PREFETCH_RAM_READ_ASSIST      0x6004D0A0; // RW   3 bits
.CONST $_USB_TX_PREFETCH_RAM_READ_ASSIST     $USB_TX_PREFETCH_RAM_READ_ASSIST; // RW   3 bits
...
.CONST $CLKGEN_DISABLE_TBUS_CORE_CLK_SPEEDUP 0xFFFF904C; // RW   1 bits
.CONST $_CLKGEN_DISABLE_TBUS_CORE_CLK_SPEEDUP $CLKGEN_DISABLE_TBUS_CORE_CLK_SPEEDUP; // RW   1 bits
...
.CONST $APPS_SCALED_CLOCK_CONTROLS           0xFFFF9280; // RW   3 bits
.CONST $_APPS_SCALED_CLOCK_CONTROLS          $APPS_SCALED_CLOCK_CONTROLS; // RW   3 bits
.CONST $APPS_SYS_PIO_DRIVE                   0xFFFF93CC; // RW  80 bits
.CONST $_APPS_SYS_PIO_DRIVE                  $APPS_SYS_PIO_DRIVE; // RW  80 bits
...
.CONST $APPS_SYS_PIO_DRIVE_ENABLE            0xFFFF93D8; // RW  80 bits
.CONST $_APPS_SYS_PIO_DRIVE_ENABLE           $APPS_SYS_PIO_DRIVE_ENABLE; // RW  80 bits
...
.CONST $APPS_SYS_PIO_STATUS                  0xFFFF93E4; //  R  80 bits
.CONST $_APPS_SYS_PIO_STATUS                 $APPS_SYS_PIO_STATUS; //  R  80 bits
...
.CONST $APPS_SYS_PIO_MUX                     0xFFFF93F0; // RW  80 bits
.CONST $_APPS_SYS_PIO_MUX                    $APPS_SYS_PIO_MUX; // RW  80 bits
...
.CONST $APPS_SYS_SDIO_1P8V_PIO_CONTROLS      0xFFFF93FC; // RW  18 bits
.CONST $_APPS_SYS_SDIO_1P8V_PIO_CONTROLS     $APPS_SYS_SDIO_1P8V_PIO_CONTROLS; // RW  18 bits
...
.CONST $READ_DECRYPT_CONTROL                 0xFFFF9500; // RW  10 bits
.CONST $_READ_DECRYPT_CONTROL                $READ_DECRYPT_CONTROL; // RW  10 bits
...
.CONST $SQIF_INST                            0xFFFF969C; // RW  16 bits
.CONST $_SQIF_INST                           $SQIF_INST; // RW  16 bits
.CONST $SQIF_CONF                            0xFFFF96A0; // RW  13 bits
.CONST $_SQIF_CONF                           $SQIF_CONF; // RW  13 bits
.CONST $SQIF_CONF2                           0xFFFF96A4; // RW  13 bits
.CONST $_SQIF_CONF2                          $SQIF_CONF2; // RW  13 bits
.CONST $SQIF_CTRL                            0xFFFF96A8; // RW  12 bits
.CONST $_SQIF_CTRL                           $SQIF_CTRL; // RW  12 bits
.CONST $SQIF_PEEK                            0xFFFF96AC; //  R   8 bits
.CONST $_SQIF_PEEK                           $SQIF_PEEK; //  R   8 bits
.CONST $SQIF_PEEK_GO                         0xFFFF96B0; // RW   1 bits
.CONST $_SQIF_PEEK_GO                        $SQIF_PEEK_GO; // RW   1 bits
.CONST $SQIF_POKE                            0xFFFF96B4; // RW   8 bits
.CONST $_SQIF_POKE                           $SQIF_POKE; // RW   8 bits
.CONST $SQIF_POKE_LAST                       0xFFFF96B8; // RW   8 bits
.CONST $_SQIF_POKE_LAST                      $SQIF_POKE_LAST; // RW   8 bits
.CONST $SQIF_PHASE_SEL0                      0xFFFF96C0; // RW  15 bits
.CONST $_SQIF_PHASE_SEL0                     $SQIF_PHASE_SEL0; // RW  15 bits
.CONST $SQIF_PHASE_SEL1                      0xFFFF96C4; // RW  15 bits
.CONST $_SQIF_PHASE_SEL1                     $SQIF_PHASE_SEL1; // RW  15 bits
.CONST $SQIF_PHASE_SEL2                      0xFFFF96C8; // RW  11 bits
.CONST $_SQIF_PHASE_SEL2                     $SQIF_PHASE_SEL2; // RW  11 bits
.CONST $SQIF_DDR_DBG_SEL                     0xFFFF96CC; // RW   8 bits
.CONST $_SQIF_DDR_DBG_SEL                    $SQIF_DDR_DBG_SEL; // RW   8 bits
.CONST $SQIF_DDR_MARGIN                      0xFFFF96D0; //  R  10 bits
.CONST $_SQIF_DDR_MARGIN                     $SQIF_DDR_MARGIN; //  R  10 bits
.CONST $SQIF_DEBUG_SEL                       0xFFFF96D4; // RW   4 bits
.CONST $_SQIF_DEBUG_SEL                      $SQIF_DEBUG_SEL; // RW   4 bits
.CONST $SQIF_FLASH_SIZE                      0xFFFF96D8; // RW   6 bits
.CONST $_SQIF_FLASH_SIZE                     $SQIF_FLASH_SIZE; // RW   6 bits
.CONST $SQIF_MUTEX_LOCK                      0xFFFF96DC; // RW   4 bits
.CONST $_SQIF_MUTEX_LOCK                     $SQIF_MUTEX_LOCK; // RW   4 bits
.CONST $SQIF_ACCESS_CTRL                     0xFFFF96E0; // RW   4 bits
.CONST $_SQIF_ACCESS_CTRL                    $SQIF_ACCESS_CTRL; // RW   4 bits
.CONST $SQIF_PAD_CAL                         0xFFFF96E4; // RW   5 bits
.CONST $_SQIF_PAD_CAL                        $SQIF_PAD_CAL; // RW   5 bits
.CONST $SQIF_RAM_CONF                        0xFFFF96E8; // RW   9 bits
.CONST $_SQIF_RAM_CONF                       $SQIF_RAM_CONF; // RW   9 bits
.CONST $SQIF_CORR_CFG                        0xFFFF96EC; // RW  14 bits
.CONST $_SQIF_CORR_CFG                       $SQIF_CORR_CFG; // RW  14 bits
.CONST $SQIF_DDR_LOCKED                      0xFFFF96F0; //  R   4 bits
.CONST $_SQIF_DDR_LOCKED                     $SQIF_DDR_LOCKED; //  R   4 bits
.CONST $SQIF_DDR_CENTER                      0xFFFF96F4; //  R  10 bits
.CONST $_SQIF_DDR_CENTER                     $SQIF_DDR_CENTER; //  R  10 bits
.CONST $SQIF_PAD_DBG                         0xFFFF96F8; //  R   6 bits
.CONST $_SQIF_PAD_DBG                        $SQIF_PAD_DBG; //  R   6 bits
.CONST $SQIF_RAM_INST                        0xFFFF96FC; // RW  16 bits
.CONST $_SQIF_RAM_INST                       $SQIF_RAM_INST; // RW  16 bits
...
.CONST $APPS_BANKED_TBUS_INT_P1_STATUS       0xFFFF99A0; // RW  16 bits
.CONST $_APPS_BANKED_TBUS_INT_P1_STATUS      $APPS_BANKED_TBUS_INT_P1_STATUS; // RW  16 bits
.CONST $APPS_BANKED_TBUS_INT_P1_ENABLES      0xFFFF99A4; // RW  16 bits
.CONST $_APPS_BANKED_TBUS_INT_P1_ENABLES     $APPS_BANKED_TBUS_INT_P1_ENABLES; // RW  16 bits
.CONST $APPS_BANKED_TBUS_INT_P1_MUTEX_LOCK   0xFFFF99A8; // RW   4 bits
.CONST $_APPS_BANKED_TBUS_INT_P1_MUTEX_LOCK  $APPS_BANKED_TBUS_INT_P1_MUTEX_LOCK; // RW   4 bits
.CONST $APPS_BANKED_TBUS_INT_P1_ACCESS_CTRL  0xFFFF99AC; // RW   4 bits
.CONST $_APPS_BANKED_TBUS_INT_P1_ACCESS_CTRL $APPS_BANKED_TBUS_INT_P1_ACCESS_CTRL; // RW   4 bits
...
.CONST $APPS_SYS_SQIF1_PRESENT               0xFFFF99E4; //  R   2 bits
.CONST $_APPS_SYS_SQIF1_PRESENT              $APPS_SYS_SQIF1_PRESENT; //  R   2 bits
.CONST $APPS_SPI_CLK_DEGLITCH_ENABLE         0xFFFF99E8; // RW   1 bits
.CONST $_APPS_SPI_CLK_DEGLITCH_ENABLE        $APPS_SPI_CLK_DEGLITCH_ENABLE; // RW   1 bits
...
.CONST $KALIMBA_PIO_INT_PIO1_EVENT_RISING_ENABLE 0xFFFF9C00; // RW  80 bits
.CONST $_KALIMBA_PIO_INT_PIO1_EVENT_RISING_ENABLE $KALIMBA_PIO_INT_PIO1_EVENT_RISING_ENABLE; // RW  80 bits
...
.CONST $KALIMBA_PIO_INT_PIO1_EVENT_FALLING_ENABLE 0xFFFF9C18; // RW  80 bits
.CONST $_KALIMBA_PIO_INT_PIO1_EVENT_FALLING_ENABLE $KALIMBA_PIO_INT_PIO1_EVENT_FALLING_ENABLE; // RW  80 bits
...
.CONST $KALIMBA_PIO_INT_PIO2_EVENT_RISING_ENABLE 0xFFFF9C30; // RW  80 bits
.CONST $_KALIMBA_PIO_INT_PIO2_EVENT_RISING_ENABLE $KALIMBA_PIO_INT_PIO2_EVENT_RISING_ENABLE; // RW  80 bits
...
.CONST $KALIMBA_PIO_INT_PIO2_EVENT_FALLING_ENABLE 0xFFFF9C48; // RW  80 bits
.CONST $_KALIMBA_PIO_INT_PIO2_EVENT_FALLING_ENABLE $KALIMBA_PIO_INT_PIO2_EVENT_FALLING_ENABLE; // RW  80 bits
...
.CONST $KALIMBA_PIO_INT_PIO1_EVENT_CAUSE     0xFFFF9C60; //  R  80 bits
.CONST $_KALIMBA_PIO_INT_PIO1_EVENT_CAUSE    $KALIMBA_PIO_INT_PIO1_EVENT_CAUSE; //  R  80 bits
...
.CONST $KALIMBA_PIO_INT_PIO2_EVENT_CAUSE     0xFFFF9C78; //  R  80 bits
.CONST $_KALIMBA_PIO_INT_PIO2_EVENT_CAUSE    $KALIMBA_PIO_INT_PIO2_EVENT_CAUSE; //  R  80 bits
...
.CONST $KALIMBA_PIO_INT_PIO1_EVENT_CAUSE_CLEAR_DATA 0xFFFF9C90; // RW  80 bits
.CONST $_KALIMBA_PIO_INT_PIO1_EVENT_CAUSE_CLEAR_DATA $KALIMBA_PIO_INT_PIO1_EVENT_CAUSE_CLEAR_DATA; // RW  80 bits
...
.CONST $KALIMBA_PIO_INT_PIO2_EVENT_CAUSE_CLEAR_DATA 0xFFFF9CA4; // RW  80 bits
.CONST $_KALIMBA_PIO_INT_PIO2_EVENT_CAUSE_CLEAR_DATA $KALIMBA_PIO_INT_PIO2_EVENT_CAUSE_CLEAR_DATA; // RW  80 bits
...
.CONST $KALIMBA_PIO_INT_TIMER_SW3_EVENT_PIO_MASK 0xFFFF9D40; // RW  80 bits
.CONST $_KALIMBA_PIO_INT_TIMER_SW3_EVENT_PIO_MASK $KALIMBA_PIO_INT_TIMER_SW3_EVENT_PIO_MASK; // RW  80 bits
...
.CONST $KALIMBA_PIO_INT_TIMER_SW3_EVENT_PIO_INVERT 0xFFFF9D58; // RW  80 bits
.CONST $_KALIMBA_PIO_INT_TIMER_SW3_EVENT_PIO_INVERT $KALIMBA_PIO_INT_TIMER_SW3_EVENT_PIO_INVERT; // RW  80 bits
...
.CONST $KALIMBA_PIO_INT_TIMER_SW3_EVENT_PIO_STATUS 0xFFFF9D70; //  R  80 bits
.CONST $_KALIMBA_PIO_INT_TIMER_SW3_EVENT_PIO_STATUS $KALIMBA_PIO_INT_TIMER_SW3_EVENT_PIO_STATUS; //  R  80 bits
...
.CONST $KALIMBA_READ_CACHE_ARBITRATION_WAIT_COUNTER_DM 0xFFFFA060; //  R  24 bits
.CONST $_KALIMBA_READ_CACHE_ARBITRATION_WAIT_COUNTER_DM $KALIMBA_READ_CACHE_ARBITRATION_WAIT_COUNTER_DM; //  R  24 bits
.CONST $KALIMBA_READ_CACHE_ARBITRATION_WAIT_COUNTER_PM 0xFFFFA064; //  R  24 bits
.CONST $_KALIMBA_READ_CACHE_ARBITRATION_WAIT_COUNTER_PM $KALIMBA_READ_CACHE_ARBITRATION_WAIT_COUNTER_PM; //  R  24 bits
.CONST $KALIMBA_READ_CACHE_NVMEM_WAIT_COUNTER_DM 0xFFFFA068; //  R  32 bits
.CONST $_KALIMBA_READ_CACHE_NVMEM_WAIT_COUNTER_DM $KALIMBA_READ_CACHE_NVMEM_WAIT_COUNTER_DM; //  R  32 bits
.CONST $KALIMBA_READ_CACHE_NVMEM_WAIT_COUNTER_PM 0xFFFFA06C; //  R  32 bits
.CONST $_KALIMBA_READ_CACHE_NVMEM_WAIT_COUNTER_PM $KALIMBA_READ_CACHE_NVMEM_WAIT_COUNTER_PM; //  R  32 bits
.CONST $KALIMBA_READ_CACHE_FSM_WAIT_COUNTER_DM 0xFFFFA070; //  R  24 bits
.CONST $_KALIMBA_READ_CACHE_FSM_WAIT_COUNTER_DM $KALIMBA_READ_CACHE_FSM_WAIT_COUNTER_DM; //  R  24 bits
.CONST $KALIMBA_READ_CACHE_FSM_WAIT_COUNTER_PM 0xFFFFA074; //  R  24 bits
.CONST $_KALIMBA_READ_CACHE_FSM_WAIT_COUNTER_PM $KALIMBA_READ_CACHE_FSM_WAIT_COUNTER_PM; //  R  24 bits
