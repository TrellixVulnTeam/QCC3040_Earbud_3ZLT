...
/*! Actually enable advertising

    \note Should only be called from a state where advertising is allowed.

    \return Returns TRUE if the advertising request was accepted, FALSE otherwise.
 */
