...
typedef enum
{
    ...
    PEER_SIG_STATE_CONNECTING_SDP_SEARCH = 3 + PEER_SIG_STATE_LOCK,/*!< Searching for Peer Signalling service */
    PEER_SIG_STATE_CONNECTING_LOCAL = 4 + PEER_SIG_STATE_LOCK,     /*!< Locally initiated connection in progress */
    PEER_SIG_STATE_CONNECTING_REMOTE = 5 + PEER_SIG_STATE_LOCK,    /*!< Remotely initiated connection is progress */
    PEER_SIG_STATE_CONNECTED = 6,                                  /*!< Connnected */
    PEER_SIG_STATE_DISCONNECTING = 7 + PEER_SIG_STATE_LOCK,        /*!< Disconnection in progress */
} appPeerSigState;
...
typedef enum
{
    ...
    /*! Channel ID for Fast Pair PName Sync messages */
    ...
    /*! Channel ID for DFU domain messages. */
    PEER_SIG_MSG_CHANNEL_DFU,
#endif


    /*! Channel ID for Fast pair ring device messages */
    PEER_SIG_MSG_CHANNEL_FP_RING_EVENT,

    /*! Channel ID for user eq messages */
    PEER_SIG_MSG_CHANNEL_USER_EQ,

    /*! Channel ID for Device Sync messages */
...
typedef enum
{
    ...
    PEER_SIG_INTERNAL_STARTUP_REQ = INTERNAL_MESSAGE_BASE,
    ...
    PEER_SIG_INTERNAL_CLOSE_SDP,

    /*! This must be the final message */
    PEER_SIG_INTERNAL_MESSAGE_END
...
/*! \brief Cancel any queued SDP search sent by this module.
    ...
    If peer signalling has sent an SDP search request and is waiting for the
