...
struct value_aghfpHandleQacReqParse_codecs
{
  uint16 codec;
};
struct region_aghfpHandleQacReqParse_codecs
{
  uint16 count;
  const uint8 *s;
  const uint8 *e;
...
struct value_aghfpHandleQacReqParse_codecs get_aghfpHandleQacReqParse_codecs(const struct region_aghfpHandleQacReqParse_codecs*, uint16);

struct value_aghfpHandleBindParse_indicators
{
  uint16 indicator;
};
struct region_aghfpHandleBindParse_indicators
{
  uint16 count;
  const uint8 *s;
  const uint8 *e;
...
struct value_aghfpHandleBindParse_indicators get_aghfpHandleBindParse_indicators(const struct region_aghfpHandleBindParse_indicators*, uint16);
...
struct aghfpHandleQacReqParse
{
  struct region_aghfpHandleQacReqParse_codecs codecs;
};
struct aghfpQceCodecSelectParse
{
  uint16 codec;
};
struct aghfpHandleBievParse
{
  uint16 assignedNum;
  uint16 value;
};
struct aghfpHandleBindParse
{
  struct region_aghfpHandleBindParse_indicators indicators;
};
...
void aghfpHandleQacReqParse(Task , const struct aghfpHandleQacReqParse *);
void aghfpQceCodecSelectParse(Task , const struct aghfpQceCodecSelectParse *);
void aghfpHandleBievParse(Task , const struct aghfpHandleBievParse *);
void aghfpHandleBindStatusRequestParse(Task );
void aghfpHandleBindParse(Task , const struct aghfpHandleBindParse *);
void aghfpHandleBindSupportRequestParse(Task );
