...
#include "nfc/nfc/nfc_panicids.h"
   ...
   /**
    ...
    /**
     * Bitserial operational error. Diatribe gives the bitserial instance.
     */
    ...
    */
     ...
     * Major versions must match and the minor version of P1
    ...
    * Arg 4 - Build ID of curator is too old for this product code
    */
    ...
    * 4 - 3rd party License check operation has failed
    */
    ...
    */
     ...
     * Diatribe gives the bitserial instance.
     */
