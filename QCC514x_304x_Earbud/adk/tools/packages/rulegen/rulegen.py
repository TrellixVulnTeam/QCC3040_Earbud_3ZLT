...
try:
    from vm_build.codegen import CommentDoxy, CommentBlock, CommentBlockDoxygen, HeaderGuards, Array, Include, Indented
    
except ImportError:
    file_dir = os.path.dirname(os.path.abspath(__file__))
    parent_dir = os.path.dirname(file_dir)
    sys.path.insert(0, os.path.join(parent_dir, "codegen"))
    from codegen import CommentDoxy, CommentBlock, CommentBlockDoxygen, HeaderGuards, Array, Include, Indented
...
def main():
    ...
    if args.format == 'yaml':
        if yaml is None:
            raise ImportError("yaml input format not supported - unable to import pyyaml package")
