                                        ...
                                        Message goal_data)
{
    ...
    if (params->enable)
    {
        ...
        PanicFalse(LeAdvertisingManager_AllowAdvertising(TwsTopProcPermitBtGetTask(), TRUE));
    ...
    else
    {
        ...
        PanicFalse(LeAdvertisingManager_AllowAdvertising(TwsTopProcPermitBtGetTask(), FALSE));
