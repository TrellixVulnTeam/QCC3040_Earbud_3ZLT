...
#define CHIP_REGISTER_HASH 0x9254
...
enum kalimba_read_cache_arbitration_wait_counter_dm_posn_enum
{
   KALIMBA_READ_CACHE_ARBITRATION_WAIT_COUNTER_DM_LSB_POSN = (int)0,
   KALIMBA_READ_CACHE_ARBITRATION_WAIT_COUNTER_DM_KALIMBA_READ_CACHE_ARBITRATION_WAIT_COUNTER_DM_LSB_POSN = (int)0,
   KALIMBA_READ_CACHE_ARBITRATION_WAIT_COUNTER_DM_MSB_POSN = (int)23,
   KALIMBA_READ_CACHE_ARBITRATION_WAIT_COUNTER_DM_KALIMBA_READ_CACHE_ARBITRATION_WAIT_COUNTER_DM_MSB_POSN = (int)23
};
typedef enum kalimba_read_cache_arbitration_wait_counter_dm_posn_enum kalimba_read_cache_arbitration_wait_counter_dm_posn;

#define KALIMBA_READ_CACHE_ARBITRATION_WAIT_COUNTER_DM_LSB_MASK (0x00000001u)
#define KALIMBA_READ_CACHE_ARBITRATION_WAIT_COUNTER_DM_MSB_MASK (0x00800000u)

enum kalimba_read_cache_arbitration_wait_counter_pm_posn_enum
{
   KALIMBA_READ_CACHE_ARBITRATION_WAIT_COUNTER_PM_LSB_POSN = (int)0,
   KALIMBA_READ_CACHE_ARBITRATION_WAIT_COUNTER_PM_KALIMBA_READ_CACHE_ARBITRATION_WAIT_COUNTER_PM_LSB_POSN = (int)0,
   KALIMBA_READ_CACHE_ARBITRATION_WAIT_COUNTER_PM_MSB_POSN = (int)23,
   KALIMBA_READ_CACHE_ARBITRATION_WAIT_COUNTER_PM_KALIMBA_READ_CACHE_ARBITRATION_WAIT_COUNTER_PM_MSB_POSN = (int)23
};
typedef enum kalimba_read_cache_arbitration_wait_counter_pm_posn_enum kalimba_read_cache_arbitration_wait_counter_pm_posn;

#define KALIMBA_READ_CACHE_ARBITRATION_WAIT_COUNTER_PM_LSB_MASK (0x00000001u)
#define KALIMBA_READ_CACHE_ARBITRATION_WAIT_COUNTER_PM_MSB_MASK (0x00800000u)
...
enum kalimba_read_cache_fsm_wait_counter_dm_posn_enum
{
   KALIMBA_READ_CACHE_FSM_WAIT_COUNTER_DM_LSB_POSN    = (int)0,
   KALIMBA_READ_CACHE_FSM_WAIT_COUNTER_DM_KALIMBA_READ_CACHE_FSM_WAIT_COUNTER_DM_LSB_POSN = (int)0,
   KALIMBA_READ_CACHE_FSM_WAIT_COUNTER_DM_MSB_POSN    = (int)23,
   KALIMBA_READ_CACHE_FSM_WAIT_COUNTER_DM_KALIMBA_READ_CACHE_FSM_WAIT_COUNTER_DM_MSB_POSN = (int)23
};
typedef enum kalimba_read_cache_fsm_wait_counter_dm_posn_enum kalimba_read_cache_fsm_wait_counter_dm_posn;

#define KALIMBA_READ_CACHE_FSM_WAIT_COUNTER_DM_LSB_MASK (0x00000001u)
#define KALIMBA_READ_CACHE_FSM_WAIT_COUNTER_DM_MSB_MASK (0x00800000u)

enum kalimba_read_cache_fsm_wait_counter_pm_posn_enum
{
   KALIMBA_READ_CACHE_FSM_WAIT_COUNTER_PM_LSB_POSN    = (int)0,
   KALIMBA_READ_CACHE_FSM_WAIT_COUNTER_PM_KALIMBA_READ_CACHE_FSM_WAIT_COUNTER_PM_LSB_POSN = (int)0,
   KALIMBA_READ_CACHE_FSM_WAIT_COUNTER_PM_MSB_POSN    = (int)23,
   KALIMBA_READ_CACHE_FSM_WAIT_COUNTER_PM_KALIMBA_READ_CACHE_FSM_WAIT_COUNTER_PM_MSB_POSN = (int)23
};
typedef enum kalimba_read_cache_fsm_wait_counter_pm_posn_enum kalimba_read_cache_fsm_wait_counter_pm_posn;

#define KALIMBA_READ_CACHE_FSM_WAIT_COUNTER_PM_LSB_MASK (0x00000001u)
#define KALIMBA_READ_CACHE_FSM_WAIT_COUNTER_PM_MSB_MASK (0x00800000u)
...
enum kalimba_read_cache_nvmem_wait_counter_dm_posn_enum
{
   KALIMBA_READ_CACHE_NVMEM_WAIT_COUNTER_DM_LSB_POSN  = (int)0,
   KALIMBA_READ_CACHE_NVMEM_WAIT_COUNTER_DM_KALIMBA_READ_CACHE_NVMEM_WAIT_COUNTER_DM_LSB_POSN = (int)0,
   KALIMBA_READ_CACHE_NVMEM_WAIT_COUNTER_DM_MSB_POSN  = (int)31,
   KALIMBA_READ_CACHE_NVMEM_WAIT_COUNTER_DM_KALIMBA_READ_CACHE_NVMEM_WAIT_COUNTER_DM_MSB_POSN = (int)31
};
typedef enum kalimba_read_cache_nvmem_wait_counter_dm_posn_enum kalimba_read_cache_nvmem_wait_counter_dm_posn;

#define KALIMBA_READ_CACHE_NVMEM_WAIT_COUNTER_DM_LSB_MASK (0x00000001u)
#define KALIMBA_READ_CACHE_NVMEM_WAIT_COUNTER_DM_MSB_MASK (0x80000000u)

enum kalimba_read_cache_nvmem_wait_counter_pm_posn_enum
{
   KALIMBA_READ_CACHE_NVMEM_WAIT_COUNTER_PM_LSB_POSN  = (int)0,
   KALIMBA_READ_CACHE_NVMEM_WAIT_COUNTER_PM_KALIMBA_READ_CACHE_NVMEM_WAIT_COUNTER_PM_LSB_POSN = (int)0,
   KALIMBA_READ_CACHE_NVMEM_WAIT_COUNTER_PM_MSB_POSN  = (int)31,
   KALIMBA_READ_CACHE_NVMEM_WAIT_COUNTER_PM_KALIMBA_READ_CACHE_NVMEM_WAIT_COUNTER_PM_MSB_POSN = (int)31
};
typedef enum kalimba_read_cache_nvmem_wait_counter_pm_posn_enum kalimba_read_cache_nvmem_wait_counter_pm_posn;

#define KALIMBA_READ_CACHE_NVMEM_WAIT_COUNTER_PM_LSB_MASK (0x00000001u)
#define KALIMBA_READ_CACHE_NVMEM_WAIT_COUNTER_PM_MSB_MASK (0x80000000u)
...
enum sqif_conf_posn_enum
{
   ...
   SQIF_CONF_DUM_MSB_POSN                             = (int)10,
   SQIF_CONF_SQIF_CONF_DUM_MSB_POSN                   = (int)10,
   SQIF_CONF_CS_HOLD_POSN                             = (int)11,
   SQIF_CONF_SQIF_CONF_CS_HOLD_LSB_POSN               = (int)11,
   SQIF_CONF_SQIF_CONF_CS_HOLD_MSB_POSN               = (int)11,
   SQIF_CONF_ABT_POSN                                 = (int)12,
   SQIF_CONF_SQIF_CONF_ABT_LSB_POSN                   = (int)12,
   SQIF_CONF_SQIF_CONF_ABT_MSB_POSN                   = (int)12
};
...
#define SQIF_CONF_DUM_MSB_MASK                   (0x00000400u)
#define SQIF_CONF_CS_HOLD_MASK                   (0x00000800u)
#define SQIF_CONF_ABT_MASK                       (0x00001000u)
...
enum sqif_conf_dum_enum
{
   ...
   SQIF_CONF_DUM_THREE                      = (int)0x4,
   SQIF_CONF_DUM_FOUR                       = (int)0x5,
   SQIF_CONF_DUM_FIVE                       = (int)0x6,
   MAX_SQIF_CONF_DUM                        = (int)0x6
};
#define NUM_SQIF_CONF_DUM (0x7)
...
enum sqif_ram_conf_posn_enum
{
   ...
   SQIF_RAM_CONF_DUM_MSB_POSN                         = (int)7,
   SQIF_RAM_CONF_SQIF_RAM_CONF_DUM_MSB_POSN           = (int)7,
   SQIF_RAM_CONF_DUM_WR_EN_POSN                       = (int)8,
   SQIF_RAM_CONF_SQIF_RAM_CONF_DUM_WR_EN_LSB_POSN     = (int)8,
   SQIF_RAM_CONF_SQIF_RAM_CONF_DUM_WR_EN_MSB_POSN     = (int)8
};
...
#define SQIF_RAM_CONF_DUM_MSB_MASK               (0x00000080u)
#define SQIF_RAM_CONF_DUM_WR_EN_MASK             (0x00000100u)

enum sqif_ram_inst_posn_enum
{
   SQIF_RAM_READ_CMD_LSB_POSN                         = (int)0,
   SQIF_RAM_INST_SQIF_RAM_READ_CMD_LSB_POSN           = (int)0,
   SQIF_RAM_READ_CMD_MSB_POSN                         = (int)7,
   SQIF_RAM_INST_SQIF_RAM_READ_CMD_MSB_POSN           = (int)7,
   SQIF_RAM_WRITE_CMD_LSB_POSN                        = (int)8,
   SQIF_RAM_INST_SQIF_RAM_WRITE_CMD_LSB_POSN          = (int)8,
   SQIF_RAM_WRITE_CMD_MSB_POSN                        = (int)15,
   SQIF_RAM_INST_SQIF_RAM_WRITE_CMD_MSB_POSN          = (int)15
};
typedef enum sqif_ram_inst_posn_enum sqif_ram_inst_posn;

#define SQIF_RAM_READ_CMD_LSB_MASK               (0x00000001u)
#define SQIF_RAM_READ_CMD_MSB_MASK               (0x00000080u)
#define SQIF_RAM_WRITE_CMD_LSB_MASK              (0x00000100u)
#define SQIF_RAM_WRITE_CMD_MSB_MASK              (0x00008000u)
...
enum host_sys_spi_enables_posn_enum
{
   HOST_SYS_SPI_STOP_OUT_EN_POSN                      = (int)0,
   HOST_SYS_SPI_ENABLES_HOST_SYS_SPI_STOP_OUT_EN_LSB_POSN = (int)0,
   HOST_SYS_SPI_ENABLES_HOST_SYS_SPI_STOP_OUT_EN_MSB_POSN = (int)0,
   HOST_SYS_SPI_DEGLITCH_EN_POSN                      = (int)1,
   HOST_SYS_SPI_ENABLES_HOST_SYS_SPI_DEGLITCH_EN_LSB_POSN = (int)1,
   HOST_SYS_SPI_ENABLES_HOST_SYS_SPI_DEGLITCH_EN_MSB_POSN = (int)1
};
typedef enum host_sys_spi_enables_posn_enum host_sys_spi_enables_posn;

#define HOST_SYS_SPI_STOP_OUT_EN_MASK            (0x00000001u)
#define HOST_SYS_SPI_DEGLITCH_EN_MASK            (0x00000002u)

enum usb_tx_prefetch_ram_0_to_3_wabl_posn_enum
{
   USB_TX_PREFETCH_RAM0_WABLM_LSB_POSN                = (int)0,
   USB_TX_PREFETCH_RAM_0_TO_3_WABL_USB_TX_PREFETCH_RAM0_WABLM_LSB_POSN = (int)0,
   USB_TX_PREFETCH_RAM0_WABLM_MSB_POSN                = (int)1,
   USB_TX_PREFETCH_RAM_0_TO_3_WABL_USB_TX_PREFETCH_RAM0_WABLM_MSB_POSN = (int)1,
   USB_TX_PREFETCH_RAM0_WABL_POSN                     = (int)2,
   USB_TX_PREFETCH_RAM_0_TO_3_WABL_USB_TX_PREFETCH_RAM0_WABL_LSB_POSN = (int)2,
   USB_TX_PREFETCH_RAM_0_TO_3_WABL_USB_TX_PREFETCH_RAM0_WABL_MSB_POSN = (int)2,
   USB_TX_PREFETCH_RAM1_WABLM_LSB_POSN                = (int)3,
   USB_TX_PREFETCH_RAM_0_TO_3_WABL_USB_TX_PREFETCH_RAM1_WABLM_LSB_POSN = (int)3,
   USB_TX_PREFETCH_RAM1_WABLM_MSB_POSN                = (int)4,
   USB_TX_PREFETCH_RAM_0_TO_3_WABL_USB_TX_PREFETCH_RAM1_WABLM_MSB_POSN = (int)4,
   USB_TX_PREFETCH_RAM1_WABL_POSN                     = (int)5,
   USB_TX_PREFETCH_RAM_0_TO_3_WABL_USB_TX_PREFETCH_RAM1_WABL_LSB_POSN = (int)5,
   USB_TX_PREFETCH_RAM_0_TO_3_WABL_USB_TX_PREFETCH_RAM1_WABL_MSB_POSN = (int)5,
   USB_TX_PREFETCH_RAM2_WABLM_LSB_POSN                = (int)6,
   USB_TX_PREFETCH_RAM_0_TO_3_WABL_USB_TX_PREFETCH_RAM2_WABLM_LSB_POSN = (int)6,
   USB_TX_PREFETCH_RAM2_WABLM_MSB_POSN                = (int)7,
   USB_TX_PREFETCH_RAM_0_TO_3_WABL_USB_TX_PREFETCH_RAM2_WABLM_MSB_POSN = (int)7,
   USB_TX_PREFETCH_RAM2_WABL_POSN                     = (int)8,
   USB_TX_PREFETCH_RAM_0_TO_3_WABL_USB_TX_PREFETCH_RAM2_WABL_LSB_POSN = (int)8,
   USB_TX_PREFETCH_RAM_0_TO_3_WABL_USB_TX_PREFETCH_RAM2_WABL_MSB_POSN = (int)8,
   USB_TX_PREFETCH_RAM3_WABLM_LSB_POSN                = (int)9,
   USB_TX_PREFETCH_RAM_0_TO_3_WABL_USB_TX_PREFETCH_RAM3_WABLM_LSB_POSN = (int)9,
   USB_TX_PREFETCH_RAM3_WABLM_MSB_POSN                = (int)10,
   USB_TX_PREFETCH_RAM_0_TO_3_WABL_USB_TX_PREFETCH_RAM3_WABLM_MSB_POSN = (int)10,
   USB_TX_PREFETCH_RAM3_WABL_POSN                     = (int)11,
   USB_TX_PREFETCH_RAM_0_TO_3_WABL_USB_TX_PREFETCH_RAM3_WABL_LSB_POSN = (int)11,
   USB_TX_PREFETCH_RAM_0_TO_3_WABL_USB_TX_PREFETCH_RAM3_WABL_MSB_POSN = (int)11
};
typedef enum usb_tx_prefetch_ram_0_to_3_wabl_posn_enum usb_tx_prefetch_ram_0_to_3_wabl_posn;

#define USB_TX_PREFETCH_RAM0_WABLM_LSB_MASK      (0x00000001u)
#define USB_TX_PREFETCH_RAM0_WABLM_MSB_MASK      (0x00000002u)
#define USB_TX_PREFETCH_RAM0_WABL_MASK           (0x00000004u)
#define USB_TX_PREFETCH_RAM1_WABLM_LSB_MASK      (0x00000008u)
#define USB_TX_PREFETCH_RAM1_WABLM_MSB_MASK      (0x00000010u)
#define USB_TX_PREFETCH_RAM1_WABL_MASK           (0x00000020u)
#define USB_TX_PREFETCH_RAM2_WABLM_LSB_MASK      (0x00000040u)
#define USB_TX_PREFETCH_RAM2_WABLM_MSB_MASK      (0x00000080u)
#define USB_TX_PREFETCH_RAM2_WABL_MASK           (0x00000100u)
#define USB_TX_PREFETCH_RAM3_WABLM_LSB_MASK      (0x00000200u)
#define USB_TX_PREFETCH_RAM3_WABLM_MSB_MASK      (0x00000400u)
#define USB_TX_PREFETCH_RAM3_WABL_MASK           (0x00000800u)

enum usb_tx_prefetch_ram_read_assist_posn_enum
{
   USB_TX_PREFETCH_RAM_RAWL_POSN                      = (int)0,
   USB_TX_PREFETCH_RAM_READ_ASSIST_USB_TX_PREFETCH_RAM_RAWL_LSB_POSN = (int)0,
   USB_TX_PREFETCH_RAM_READ_ASSIST_USB_TX_PREFETCH_RAM_RAWL_MSB_POSN = (int)0,
   USB_TX_PREFETCH_RAM_RAWLM_LSB_POSN                 = (int)1,
   USB_TX_PREFETCH_RAM_READ_ASSIST_USB_TX_PREFETCH_RAM_RAWLM_LSB_POSN = (int)1,
   USB_TX_PREFETCH_RAM_RAWLM_MSB_POSN                 = (int)2,
   USB_TX_PREFETCH_RAM_READ_ASSIST_USB_TX_PREFETCH_RAM_RAWLM_MSB_POSN = (int)2
};
typedef enum usb_tx_prefetch_ram_read_assist_posn_enum usb_tx_prefetch_ram_read_assist_posn;

#define USB_TX_PREFETCH_RAM_RAWL_MASK            (0x00000001u)
#define USB_TX_PREFETCH_RAM_RAWLM_LSB_MASK       (0x00000002u)
#define USB_TX_PREFETCH_RAM_RAWLM_MSB_MASK       (0x00000004u)
...
enum apps_sys_debug_source_enum
{
   ...
   APPS_SYS_DEBUG_SOURCE_BUS_MEM2_ADPTR     = (int)0x19,
   APPS_SYS_DEBUG_SOURCE_KAL0_ACTIVITY      = (int)0x1A,
   APPS_SYS_DEBUG_SOURCE_KAL1_ACTIVITY      = (int)0x1B,
   APPS_SYS_DEBUG_SOURCE_KAL0_EXECUTION     = (int)0x1C,
   APPS_SYS_DEBUG_SOURCE_KAL1_EXECUTION     = (int)0x1D,
   APPS_SYS_DEBUG_SOURCE_KAL0_PM_MUX        = (int)0x1E,
   APPS_SYS_DEBUG_SOURCE_KAL1_PM_MUX        = (int)0x1F,
   APPS_SYS_DEBUG_SOURCE_KAL0_READ_CACHE_DM = (int)0x20,
   APPS_SYS_DEBUG_SOURCE_KAL1_READ_CACHE_DM = (int)0x21,
   APPS_SYS_DEBUG_SOURCE_CACHE0_RAM0_MUX    = (int)0x22,
   APPS_SYS_DEBUG_SOURCE_CACHE0_RAM1_MUX    = (int)0x23,
   APPS_SYS_DEBUG_SOURCE_CACHE0_TAG_RAM_MUX = (int)0x24,
   APPS_SYS_DEBUG_SOURCE_CACHE1_RAM0_MUX    = (int)0x25,
   APPS_SYS_DEBUG_SOURCE_CACHE1_RAM1_MUX    = (int)0x26,
   APPS_SYS_DEBUG_SOURCE_CACHE1_TAG_RAM_MUX = (int)0x27,
   APPS_SYS_DEBUG_SOURCE_KAL0_DM_RAM_MUX    = (int)0x28,
   APPS_SYS_DEBUG_SOURCE_KAL1_DM_RAM_MUX    = (int)0x29,
   APPS_SYS_DEBUG_SOURCE_REG_BUS_WAIT0      = (int)0x2A,
   APPS_SYS_DEBUG_SOURCE_REG_BUS_WAIT1      = (int)0x2B,
   APPS_SYS_DEBUG_SOURCE_REG_BUS_READ_DATA  = (int)0x2C,
   APPS_SYS_DEBUG_SOURCE_REG_BUS_WRITE_DATA = (int)0x2D,
   APPS_SYS_DEBUG_SOURCE_CORE_VITALS        = (int)0x2E,
   APPS_SYS_DEBUG_SOURCE_SQIF0_TBUS_BRIDGE  = (int)0x2F,
   APPS_SYS_DEBUG_SOURCE_SQIF1_TBUS_BRIDGE  = (int)0x30,
   APPS_SYS_DEBUG_SOURCE_KAL0_PC            = (int)0x31,
   APPS_SYS_DEBUG_SOURCE_KAL1_PC            = (int)0x32,
   APPS_SYS_DEBUG_SOURCE_KAL_PM_BKPOINTS    = (int)0x33,
   APPS_SYS_DEBUG_SOURCE_AUTO_SLEEP_CPU_DM0 = (int)0x34,
   APPS_SYS_DEBUG_SOURCE_AUTO_SLEEP_CPU_DM1 = (int)0x35,
   APPS_SYS_DEBUG_SOURCE_AUTO_SLEEP_SHARED1 = (int)0x36,
   APPS_SYS_DEBUG_SOURCE_AUTO_SLEEP_SHARED2 = (int)0x37,
   APPS_SYS_DEBUG_SOURCE_AUTO_SLEEP_TCM     = (int)0x38,
   APPS_SYS_DEBUG_SOURCE_AUTO_SLEEP_CACHE0  = (int)0x39,
   APPS_SYS_DEBUG_SOURCE_AUTO_SLEEP_CACHE1  = (int)0x3A,
   APPS_SYS_DEBUG_SOURCE_TRACE              = (int)0x3B,
   APPS_SYS_DEBUG_SOURCE_VM_INTERCONNECT    = (int)0x3C,
   APPS_SYS_DEBUG_SOURCE_KALIMBA_DEBUG_MUX  = (int)0x3D,
   APPS_SYS_DEBUG_SOURCE_APU                = (int)0x3E,
   APPS_SYS_DEBUG_SOURCE_DEBUG_MUX          = (int)0x3F,
   APPS_SYS_DEBUG_SOURCE_MISC_TBUS_ARB      = (int)0x40,
   APPS_SYS_DEBUG_SOURCE_EXT_REGS           = (int)0x41,
   APPS_SYS_DEBUG_SOURCE_TCM0_LOWER_MUX     = (int)0x42,
   APPS_SYS_DEBUG_SOURCE_TCM0_UPPER_MUX     = (int)0x43,
   APPS_SYS_DEBUG_SOURCE_TCM1_MUX           = (int)0x44,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_CPU0_CACHE_RAM0_0 = (int)0x45,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_CPU0_CACHE_RAM0_1 = (int)0x46,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_CPU0_CACHE_RAM1_0 = (int)0x47,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_CPU0_CACHE_RAM1_1 = (int)0x48,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_CPU0_CACHE_TAG = (int)0x49,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_CPU0_DM_0  = (int)0x4A,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_CPU0_DM_1  = (int)0x4B,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_CPU0_DM_2  = (int)0x4C,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_CPU0_DM_3  = (int)0x4D,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_CPU0_DM_4  = (int)0x4E,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_CPU1_CACHE_RAM0 = (int)0x4F,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_CPU1_CACHE_RAM1 = (int)0x50,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_CPU1_CACHE_TAG = (int)0x51,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_CPU1_DM_0  = (int)0x52,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_CPU1_DM_1  = (int)0x53,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_CPU1_DM_2  = (int)0x54,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_CPU1_DM_3  = (int)0x55,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_CPU1_DM_4  = (int)0x56,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_TCM1_0     = (int)0x57,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_TCM1_1     = (int)0x58,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_SDIO_HOST_0 = (int)0x59,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_SDIO_HOST_1 = (int)0x5A,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_TCM0_LOWER = (int)0x5B,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_TCM0_UPPER = (int)0x5C,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_SHARED_MEM_0 = (int)0x5D,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_SHARED_MEM_1 = (int)0x5E,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_SHARED_MEM_2 = (int)0x5F,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_SHARED_MEM_3 = (int)0x60,
   APPS_SYS_DEBUG_SOURCE_LAST               = (int)0x60,
   ...
   MAX_APPS_SYS_DEBUG_SOURCE                = (int)0x60
};
...
enum dmac_key_sel_enum
{
   ...
   RTL3_KEY_SEL                             = (int)0x3,
   RTL4_KEY_SEL                             = (int)0x4,
   RTL5_KEY_SEL                             = (int)0x5,
   RTL6_KEY_SEL                             = (int)0x6,
   RTL7_KEY_SEL                             = (int)0x7,
   RTL8_KEY_SEL                             = (int)0x8,
   MAX_DMAC_KEY_SEL                         = (int)0x8
};
#define NUM_DMAC_KEY_SEL (0x9)
...
enum apps_scaled_clock_controls_posn_enum
{
   SCALED_CLOCK_TBUS_ADAPTERS_MASK_POSN               = (int)0,
   APPS_SCALED_CLOCK_CONTROLS_SCALED_CLOCK_TBUS_ADAPTERS_MASK_LSB_POSN = (int)0,
   APPS_SCALED_CLOCK_CONTROLS_SCALED_CLOCK_TBUS_ADAPTERS_MASK_MSB_POSN = (int)0,
   SCALED_CLOCK_HW_MASK_POSN                          = (int)1,
   APPS_SCALED_CLOCK_CONTROLS_SCALED_CLOCK_HW_MASK_LSB_POSN = (int)1,
   APPS_SCALED_CLOCK_CONTROLS_SCALED_CLOCK_HW_MASK_MSB_POSN = (int)1,
   SCALED_CLOCK_ALLOW_POSN                            = (int)2,
   APPS_SCALED_CLOCK_CONTROLS_SCALED_CLOCK_ALLOW_LSB_POSN = (int)2,
   APPS_SCALED_CLOCK_CONTROLS_SCALED_CLOCK_ALLOW_MSB_POSN = (int)2
};
typedef enum apps_scaled_clock_controls_posn_enum apps_scaled_clock_controls_posn;

#define SCALED_CLOCK_TBUS_ADAPTERS_MASK_MASK     (0x00000001u)
#define SCALED_CLOCK_HW_MASK_MASK                (0x00000002u)
#define SCALED_CLOCK_ALLOW_MASK                  (0x00000004u)
...
enum apps_sys_sdio_1p8v_pio_controls_posn_enum
{
   APPS_SYS_SDIO_SLOT0_PIO_ENABLE_POSN                = (int)0,
   APPS_SYS_SDIO_1P8V_PIO_CONTROLS_APPS_SYS_SDIO_SLOT0_PIO_ENABLE_LSB_POSN = (int)0,
   APPS_SYS_SDIO_1P8V_PIO_CONTROLS_APPS_SYS_SDIO_SLOT0_PIO_ENABLE_MSB_POSN = (int)0,
   APPS_SYS_SDIO_SLOT0_PIO_SELECT_LSB_POSN            = (int)1,
   APPS_SYS_SDIO_1P8V_PIO_CONTROLS_APPS_SYS_SDIO_SLOT0_PIO_SELECT_LSB_POSN = (int)1,
   APPS_SYS_SDIO_SLOT0_PIO_SELECT_MSB_POSN            = (int)7,
   APPS_SYS_SDIO_1P8V_PIO_CONTROLS_APPS_SYS_SDIO_SLOT0_PIO_SELECT_MSB_POSN = (int)7,
   APPS_SYS_SDIO_SLOT0_PIO_INVERT_POSN                = (int)8,
   APPS_SYS_SDIO_1P8V_PIO_CONTROLS_APPS_SYS_SDIO_SLOT0_PIO_INVERT_LSB_POSN = (int)8,
   APPS_SYS_SDIO_1P8V_PIO_CONTROLS_APPS_SYS_SDIO_SLOT0_PIO_INVERT_MSB_POSN = (int)8,
   APPS_SYS_SDIO_SLOT1_PIO_ENABLE_POSN                = (int)9,
   APPS_SYS_SDIO_1P8V_PIO_CONTROLS_APPS_SYS_SDIO_SLOT1_PIO_ENABLE_LSB_POSN = (int)9,
   APPS_SYS_SDIO_1P8V_PIO_CONTROLS_APPS_SYS_SDIO_SLOT1_PIO_ENABLE_MSB_POSN = (int)9,
   APPS_SYS_SDIO_SLOT1_PIO_SELECT_LSB_POSN            = (int)10,
   APPS_SYS_SDIO_1P8V_PIO_CONTROLS_APPS_SYS_SDIO_SLOT1_PIO_SELECT_LSB_POSN = (int)10,
   APPS_SYS_SDIO_SLOT1_PIO_SELECT_MSB_POSN            = (int)16,
   APPS_SYS_SDIO_1P8V_PIO_CONTROLS_APPS_SYS_SDIO_SLOT1_PIO_SELECT_MSB_POSN = (int)16,
   APPS_SYS_SDIO_SLOT1_PIO_INVERT_POSN                = (int)17,
   APPS_SYS_SDIO_1P8V_PIO_CONTROLS_APPS_SYS_SDIO_SLOT1_PIO_INVERT_LSB_POSN = (int)17,
   APPS_SYS_SDIO_1P8V_PIO_CONTROLS_APPS_SYS_SDIO_SLOT1_PIO_INVERT_MSB_POSN = (int)17
};
typedef enum apps_sys_sdio_1p8v_pio_controls_posn_enum apps_sys_sdio_1p8v_pio_controls_posn;

#define APPS_SYS_SDIO_SLOT0_PIO_ENABLE_MASK      (0x00000001u)
#define APPS_SYS_SDIO_SLOT0_PIO_SELECT_LSB_MASK  (0x00000002u)
#define APPS_SYS_SDIO_SLOT0_PIO_SELECT_MSB_MASK  (0x00000080u)
#define APPS_SYS_SDIO_SLOT0_PIO_INVERT_MASK      (0x00000100u)
#define APPS_SYS_SDIO_SLOT1_PIO_ENABLE_MASK      (0x00000200u)
#define APPS_SYS_SDIO_SLOT1_PIO_SELECT_LSB_MASK  (0x00000400u)
#define APPS_SYS_SDIO_SLOT1_PIO_SELECT_MSB_MASK  (0x00010000u)
#define APPS_SYS_SDIO_SLOT1_PIO_INVERT_MASK      (0x00020000u)
...
enum apps_sys_mux_enum
{
   ...
   APPS_SYS_MUX_REMOTE_DATA2_IN             = (int)0x9,
   APPS_SYS_MUX_DEBUG                       = (int)0xF,
   APPS_SYS_MUX_NUM_QUEUES                  = (int)0xA,
...
{
   APPS_SYS_MUX_CONNECTED_BLOCKS            = (int)0x3FF,
   MAX_APPS_SYS_MUX_CONNECTED               = (int)0x3FF
};
typedef enum apps_sys_mux_connected_enum apps_sys_mux_connected;


enum apps_spi_clk_deglitch_enable_posn_enum
{
   APPS_SPI_CLK_DEGLITCH_ENABLE_POSN                  = (int)0,
   APPS_SPI_CLK_DEGLITCH_ENABLE_APPS_SPI_CLK_DEGLITCH_ENABLE_LSB_POSN = (int)0,
   APPS_SPI_CLK_DEGLITCH_ENABLE_APPS_SPI_CLK_DEGLITCH_ENABLE_MSB_POSN = (int)0
};
typedef enum apps_spi_clk_deglitch_enable_posn_enum apps_spi_clk_deglitch_enable_posn;

#define APPS_SPI_CLK_DEGLITCH_ENABLE_MASK        (0x00000001u)
...
#if defined(IO_DEFS_MODULE_APPS_BANKED_TBUS_INT_P1) 

#ifndef __IO_DEFS_H__IO_DEFS_MODULE_APPS_BANKED_TBUS_INT_P1
#define __IO_DEFS_H__IO_DEFS_MODULE_APPS_BANKED_TBUS_INT_P1

/* -- apps_banked_tbus_int_p1 -- Control of banked TBus interrupts for P1 -- */

enum apps_banked_tbus_int_p1_enables_posn_enum
{
   APPS_BANKED_TBUS_INT_P1_ENABLES_LSB_POSN           = (int)0,
   APPS_BANKED_TBUS_INT_P1_ENABLES_APPS_BANKED_TBUS_INT_P1_ENABLES_LSB_POSN = (int)0,
   APPS_BANKED_TBUS_INT_P1_ENABLES_MSB_POSN           = (int)15,
   APPS_BANKED_TBUS_INT_P1_ENABLES_APPS_BANKED_TBUS_INT_P1_ENABLES_MSB_POSN = (int)15
};
typedef enum apps_banked_tbus_int_p1_enables_posn_enum apps_banked_tbus_int_p1_enables_posn;

#define APPS_BANKED_TBUS_INT_P1_ENABLES_LSB_MASK (0x00000001u)
#define APPS_BANKED_TBUS_INT_P1_ENABLES_MSB_MASK (0x00008000u)

enum apps_banked_tbus_int_p1_status_posn_enum
{
   APPS_BANKED_TBUS_INT_P1_STATUS_LSB_POSN            = (int)0,
   APPS_BANKED_TBUS_INT_P1_STATUS_APPS_BANKED_TBUS_INT_P1_STATUS_LSB_POSN = (int)0,
   APPS_BANKED_TBUS_INT_P1_STATUS_MSB_POSN            = (int)15,
   APPS_BANKED_TBUS_INT_P1_STATUS_APPS_BANKED_TBUS_INT_P1_STATUS_MSB_POSN = (int)15
};
typedef enum apps_banked_tbus_int_p1_status_posn_enum apps_banked_tbus_int_p1_status_posn;

#define APPS_BANKED_TBUS_INT_P1_STATUS_LSB_MASK  (0x00000001u)
#define APPS_BANKED_TBUS_INT_P1_STATUS_MSB_MASK  (0x00008000u)

enum apps_banked_tbus_int_p1__access_ctrl_enum_posn_enum
{
   APPS_BANKED_TBUS_INT_P1__P0_ACCESS_PERMISSION_POSN = (int)0,
   APPS_BANKED_TBUS_INT_P1__ACCESS_CTRL_ENUM_APPS_BANKED_TBUS_INT_P1__P0_ACCESS_PERMISSION_LSB_POSN = (int)0,
   APPS_BANKED_TBUS_INT_P1__ACCESS_CTRL_ENUM_APPS_BANKED_TBUS_INT_P1__P0_ACCESS_PERMISSION_MSB_POSN = (int)0,
   APPS_BANKED_TBUS_INT_P1__P1_ACCESS_PERMISSION_POSN = (int)1,
   APPS_BANKED_TBUS_INT_P1__ACCESS_CTRL_ENUM_APPS_BANKED_TBUS_INT_P1__P1_ACCESS_PERMISSION_LSB_POSN = (int)1,
   APPS_BANKED_TBUS_INT_P1__ACCESS_CTRL_ENUM_APPS_BANKED_TBUS_INT_P1__P1_ACCESS_PERMISSION_MSB_POSN = (int)1,
   APPS_BANKED_TBUS_INT_P1__P2_ACCESS_PERMISSION_POSN = (int)2,
   APPS_BANKED_TBUS_INT_P1__ACCESS_CTRL_ENUM_APPS_BANKED_TBUS_INT_P1__P2_ACCESS_PERMISSION_LSB_POSN = (int)2,
   APPS_BANKED_TBUS_INT_P1__ACCESS_CTRL_ENUM_APPS_BANKED_TBUS_INT_P1__P2_ACCESS_PERMISSION_MSB_POSN = (int)2,
   APPS_BANKED_TBUS_INT_P1__P3_ACCESS_PERMISSION_POSN = (int)3,
   APPS_BANKED_TBUS_INT_P1__ACCESS_CTRL_ENUM_APPS_BANKED_TBUS_INT_P1__P3_ACCESS_PERMISSION_LSB_POSN = (int)3,
   APPS_BANKED_TBUS_INT_P1__ACCESS_CTRL_ENUM_APPS_BANKED_TBUS_INT_P1__P3_ACCESS_PERMISSION_MSB_POSN = (int)3
};
typedef enum apps_banked_tbus_int_p1__access_ctrl_enum_posn_enum apps_banked_tbus_int_p1__access_ctrl_enum_posn;

#define APPS_BANKED_TBUS_INT_P1__P0_ACCESS_PERMISSION_MASK (0x00000001u)
#define APPS_BANKED_TBUS_INT_P1__P1_ACCESS_PERMISSION_MASK (0x00000002u)
#define APPS_BANKED_TBUS_INT_P1__P2_ACCESS_PERMISSION_MASK (0x00000004u)
#define APPS_BANKED_TBUS_INT_P1__P3_ACCESS_PERMISSION_MASK (0x00000008u)

enum apps_banked_tbus_int_p1__p0_access_permission_enum
{
   APPS_BANKED_TBUS_INT_P1__P0_ACCESS_BLOCKED = (int)0x0,
   APPS_BANKED_TBUS_INT_P1__P0_ACCESS_UNBLOCKED = (int)0x1,
   MAX_APPS_BANKED_TBUS_INT_P1__P0_ACCESS_PERMISSION = (int)0x1
};
#define NUM_APPS_BANKED_TBUS_INT_P1__P0_ACCESS_PERMISSION (0x2)
typedef enum apps_banked_tbus_int_p1__p0_access_permission_enum apps_banked_tbus_int_p1__p0_access_permission;


enum apps_banked_tbus_int_p1__p1_access_permission_enum
{
   APPS_BANKED_TBUS_INT_P1__P1_ACCESS_BLOCKED = (int)0x0,
   APPS_BANKED_TBUS_INT_P1__P1_ACCESS_UNBLOCKED = (int)0x1,
   MAX_APPS_BANKED_TBUS_INT_P1__P1_ACCESS_PERMISSION = (int)0x1
};
#define NUM_APPS_BANKED_TBUS_INT_P1__P1_ACCESS_PERMISSION (0x2)
typedef enum apps_banked_tbus_int_p1__p1_access_permission_enum apps_banked_tbus_int_p1__p1_access_permission;


enum apps_banked_tbus_int_p1__p2_access_permission_enum
{
   APPS_BANKED_TBUS_INT_P1__P2_ACCESS_BLOCKED = (int)0x0,
   APPS_BANKED_TBUS_INT_P1__P2_ACCESS_UNBLOCKED = (int)0x1,
   MAX_APPS_BANKED_TBUS_INT_P1__P2_ACCESS_PERMISSION = (int)0x1
};
#define NUM_APPS_BANKED_TBUS_INT_P1__P2_ACCESS_PERMISSION (0x2)
typedef enum apps_banked_tbus_int_p1__p2_access_permission_enum apps_banked_tbus_int_p1__p2_access_permission;


enum apps_banked_tbus_int_p1__p3_access_permission_enum
{
   APPS_BANKED_TBUS_INT_P1__P3_ACCESS_BLOCKED = (int)0x0,
   APPS_BANKED_TBUS_INT_P1__P3_ACCESS_UNBLOCKED = (int)0x1,
   MAX_APPS_BANKED_TBUS_INT_P1__P3_ACCESS_PERMISSION = (int)0x1
};
#define NUM_APPS_BANKED_TBUS_INT_P1__P3_ACCESS_PERMISSION (0x2)
typedef enum apps_banked_tbus_int_p1__p3_access_permission_enum apps_banked_tbus_int_p1__p3_access_permission;


enum apps_banked_tbus_int_p1__mutex_lock_enum_enum
{
   APPS_BANKED_TBUS_INT_P1__MUTEX_AVAILABLE = (int)0x0,
   APPS_BANKED_TBUS_INT_P1__MUTEX_CLAIMED_BY_P0 = (int)0x1,
   APPS_BANKED_TBUS_INT_P1__MUTEX_CLAIMED_BY_P1 = (int)0x2,
   APPS_BANKED_TBUS_INT_P1__MUTEX_CLAIMED_BY_P2 = (int)0x4,
   APPS_BANKED_TBUS_INT_P1__MUTEX_CLAIMED_BY_P3 = (int)0x8,
   APPS_BANKED_TBUS_INT_P1__MUTEX_DISABLED  = (int)0xF,
   MAX_APPS_BANKED_TBUS_INT_P1__MUTEX_LOCK_ENUM = (int)0xF
};
typedef enum apps_banked_tbus_int_p1__mutex_lock_enum_enum apps_banked_tbus_int_p1__mutex_lock_enum;


enum apps_banked_tbus_int_p1_access_ctrl_posn_enum
{
   APPS_BANKED_TBUS_INT_P1_ACCESS_CTRL_APPS_BANKED_TBUS_INT_P1__P0_ACCESS_PERMISSION_LSB_POSN = (int)0,
   APPS_BANKED_TBUS_INT_P1_ACCESS_CTRL_APPS_BANKED_TBUS_INT_P1__P0_ACCESS_PERMISSION_MSB_POSN = (int)0,
   APPS_BANKED_TBUS_INT_P1_ACCESS_CTRL_APPS_BANKED_TBUS_INT_P1__P1_ACCESS_PERMISSION_LSB_POSN = (int)1,
   APPS_BANKED_TBUS_INT_P1_ACCESS_CTRL_APPS_BANKED_TBUS_INT_P1__P1_ACCESS_PERMISSION_MSB_POSN = (int)1,
   APPS_BANKED_TBUS_INT_P1_ACCESS_CTRL_APPS_BANKED_TBUS_INT_P1__P2_ACCESS_PERMISSION_LSB_POSN = (int)2,
   APPS_BANKED_TBUS_INT_P1_ACCESS_CTRL_APPS_BANKED_TBUS_INT_P1__P2_ACCESS_PERMISSION_MSB_POSN = (int)2,
   APPS_BANKED_TBUS_INT_P1_ACCESS_CTRL_APPS_BANKED_TBUS_INT_P1__P3_ACCESS_PERMISSION_LSB_POSN = (int)3,
   APPS_BANKED_TBUS_INT_P1_ACCESS_CTRL_APPS_BANKED_TBUS_INT_P1__P3_ACCESS_PERMISSION_MSB_POSN = (int)3
};
typedef enum apps_banked_tbus_int_p1_access_ctrl_posn_enum apps_banked_tbus_int_p1_access_ctrl_posn;


#endif /* IO_DEFS_MODULE_APPS_BANKED_TBUS_INT_P1 */
#endif /* __IO_DEFS_H__IO_DEFS_MODULE_APPS_BANKED_TBUS_INT_P1 */
...
#define P0D_P1_DM_RAM_UPPER                                (0x0001a000u)
#define P0D_P0_DM_RAM_LOWER                                (0x00000000u)
#define P0D_P0_DM_RAM_UPPER                                (0x0000a000u)
...
#define P1D_P0_DM_RAM_UPPER                                (0x0000a000u)
#define P1D_P1_DM_RAM_LOWER                                (0x00010000u)
#define P1D_P1_DM_RAM_UPPER                                (0x0001a000u)
...
#define PxD_P0_DM_RAM_UPPER                                (0x0000a000u)
#define PxD_P1_DM_RAM_LOWER                                (0x00010000u)
#define PxD_P1_DM_RAM_UPPER                                (0x0001a000u)
#define PxD_SHARED_DM_RAM_LOWER                            (0x10000000u)
#define PxD_SHARED_DM_RAM_UPPER                            (0x10008000u)
#define PxD_TCM0_LOWER                                     (0x20000000u)
#define PxD_TCM0_UPPER                                     (0x20008000u)
#define PxD_TCM1_LOWER                                     (0x20008000u)
#define PxD_TCM1_UPPER                                     (0x20010000u)
...
#define PxP_TCM0_UPPER                                     (0x00808000u)
#define PxP_TCM0_SIZE                                      (0x00006000u)
#define PxP_TCM1_LOWER                                     (0x00808000u)
#define PxP_TCM1_UPPER                                     (0x00810000u)
#define PxP_TCM1_SIZE                                      (0x00004000u)
...
#define ADDR_SEL_PM_LSB                                    (0x0000000fu)
...
#define MAP_P0_DM_RAM_UPPER                                (0x0000a000u)
#define MAP_P1_DM_RAM_LOWER                                (0x00010000u)
#define MAP_P1_DM_RAM_UPPER                                (0x0001a000u)
#define MAP_TCM0_LOWER                                     (0x20000000u)
#define MAP_TCM0_UPPER                                     (0x20008000u)
#define MAP_TCM1_LOWER                                     (0x20008000u)
#define MAP_TCM1_UPPER                                     (0x20010000u)
...
enum clkgen_debug_activity_enum
{
   ...
   CLKGEN_DEBUG_ACTIVITY_TBUS_MEM2_ACTIVITY = (int)0xB,
   CLKGEN_DEBUG_ACTIVITY_VM_ACTIVITY        = (int)0xC,
   CLKGEN_DEBUG_ACTIVITY_DMAC_ACTIVITY      = (int)0xD,
   CLKGEN_DEBUG_ACTIVITY_REQ_CLK_REGS       = (int)0xE,
   CLKGEN_DEBUG_ACTIVITY_REQ_CLK_SQIF_REGS0 = (int)0xF,
   CLKGEN_DEBUG_ACTIVITY_REQ_CLK_SQIF_REGS1 = (int)0x10,
   CLKGEN_DEBUG_ACTIVITY_REQ_CLK_DSP_REGS0  = (int)0x11,
   CLKGEN_DEBUG_ACTIVITY_REQ_CLK_DSP_REGS1  = (int)0x12,
   CLKGEN_DEBUG_ACTIVITY_REQ_CLK_TBUS_REGS  = (int)0x13,
   CLKGEN_DEBUG_ACTIVITY_REQ_CLK_TBUS_MSG_REGS = (int)0x15,
   CLKGEN_DEBUG_ACTIVITY_REQ_CLK_LED_CTRL_REGS = (int)0x16,
   CLKGEN_DEBUG_ACTIVITY_DSP_EXTERNAL_ACCESS_ACTIVITY0 = (int)0x17,
   CLKGEN_DEBUG_ACTIVITY_DSP_EXTERNAL_ACCESS_ACTIVITY1 = (int)0x18,
   CLKGEN_DEBUG_ACTIVITY_TBUS_REM_ACTIVITY0 = (int)0x19,
   CLKGEN_DEBUG_ACTIVITY_TBUS_REM_ACTIVITY1 = (int)0x1A,
   CLKGEN_DEBUG_ACTIVITY_REQ_CLK_DSP_CACHE0 = (int)0x1B,
   CLKGEN_DEBUG_ACTIVITY_REQ_CLK_DSP_CACHE1 = (int)0x1C,
   CLKGEN_DEBUG_ACTIVITY_SDIO_HOST_FORCE_CLOCKS_ACTIVE = (int)0x1,
   MAX_CLKGEN_DEBUG_ACTIVITY                = (int)0x1C
};
...
enum clkgen_disable_tbus_core_clk_speedup_posn_enum
{
   CLKGEN_DISABLE_TBUS_CORE_CLK_SPEEDUP_POSN          = (int)0,
   CLKGEN_DISABLE_TBUS_CORE_CLK_SPEEDUP_CLKGEN_DISABLE_TBUS_CORE_CLK_SPEEDUP_LSB_POSN = (int)0,
   CLKGEN_DISABLE_TBUS_CORE_CLK_SPEEDUP_CLKGEN_DISABLE_TBUS_CORE_CLK_SPEEDUP_MSB_POSN = (int)0
};
typedef enum clkgen_disable_tbus_core_clk_speedup_posn_enum clkgen_disable_tbus_core_clk_speedup_posn;

#define CLKGEN_DISABLE_TBUS_CORE_CLK_SPEEDUP_MASK (0x00000001u)
...
enum int_load_info_posn_enum
{
   ...
   INT_LOAD_INFO_SOURCE_MSB_POSN                      = (int)6,
   INT_LOAD_INFO_INT_LOAD_INFO_SOURCE_MSB_POSN        = (int)6,
   INT_LOAD_INFO_UNUSED7_LSB_POSN                     = (int)7,
   INT_LOAD_INFO_INT_LOAD_INFO_UNUSED7_LSB_POSN       = (int)7,
   INT_LOAD_INFO_UNUSED7_MSB_POSN                     = (int)9,
   INT_LOAD_INFO_INT_LOAD_INFO_UNUSED7_MSB_POSN       = (int)9,
   ...
   INT_LOAD_INFO_REQUEST_MSB_POSN                     = (int)15,
   INT_LOAD_INFO_INT_LOAD_INFO_REQUEST_MSB_POSN       = (int)15,
   INT_LOAD_INFO_UNUSED16_LSB_POSN                    = (int)16,
   INT_LOAD_INFO_INT_LOAD_INFO_UNUSED16_LSB_POSN      = (int)16,
   INT_LOAD_INFO_UNUSED16_MSB_POSN                    = (int)18,
   INT_LOAD_INFO_INT_LOAD_INFO_UNUSED16_MSB_POSN      = (int)18,
...
#define INT_LOAD_INFO_SOURCE_MSB_MASK            (0x00000040u)
#define INT_LOAD_INFO_UNUSED7_LSB_MASK           (0x00000080u)
#define INT_LOAD_INFO_UNUSED7_MSB_MASK           (0x00000200u)
#define INT_LOAD_INFO_INT_ACTIVE_MASK            (0x00000400u)
#define INT_LOAD_INFO_REQUEST_LSB_MASK           (0x00000800u)
#define INT_LOAD_INFO_REQUEST_MSB_MASK           (0x00008000u)
#define INT_LOAD_INFO_UNUSED16_LSB_MASK          (0x00010000u)
#define INT_LOAD_INFO_UNUSED16_MSB_MASK          (0x00040000u)
...
enum int_save_info_posn_enum
{
   ...
   INT_SAVE_INFO_SOURCE_MSB_POSN                      = (int)6,
   INT_SAVE_INFO_INT_SAVE_INFO_SOURCE_MSB_POSN        = (int)6,
   INT_SAVE_INFO_UNUSED7_LSB_POSN                     = (int)7,
   INT_SAVE_INFO_INT_SAVE_INFO_UNUSED7_LSB_POSN       = (int)7,
   INT_SAVE_INFO_UNUSED7_MSB_POSN                     = (int)9,
   INT_SAVE_INFO_INT_SAVE_INFO_UNUSED7_MSB_POSN       = (int)9,
   ...
   INT_SAVE_INFO_SOURCE_NEW_MSB_POSN                  = (int)15,
   INT_SAVE_INFO_INT_SAVE_INFO_SOURCE_NEW_MSB_POSN    = (int)15,
   INT_SAVE_INFO_UNUSED16_LSB_POSN                    = (int)16,
   INT_SAVE_INFO_INT_SAVE_INFO_UNUSED16_LSB_POSN      = (int)16,
   INT_SAVE_INFO_UNUSED16_MSB_POSN                    = (int)18,
   INT_SAVE_INFO_INT_SAVE_INFO_UNUSED16_MSB_POSN      = (int)18,
...
#define INT_SAVE_INFO_SOURCE_MSB_MASK            (0x00000040u)
#define INT_SAVE_INFO_UNUSED7_LSB_MASK           (0x00000080u)
#define INT_SAVE_INFO_UNUSED7_MSB_MASK           (0x00000200u)
#define INT_SAVE_INFO_ACTIVE_MASK                (0x00000400u)
#define INT_SAVE_INFO_SOURCE_NEW_LSB_MASK        (0x00000800u)
#define INT_SAVE_INFO_SOURCE_NEW_MSB_MASK        (0x00008000u)
#define INT_SAVE_INFO_UNUSED16_LSB_MASK          (0x00010000u)
#define INT_SAVE_INFO_UNUSED16_MSB_MASK          (0x00040000u)
...
enum sqif_datapath_perf_counter_sel_enum
{
   SQIF_DATAPATH_PERF_COUNTER_SEL_ARBITRATION_WAITS = (int)0x0,
   SQIF_DATAPATH_PERF_COUNTER_SEL_SQIF_WAITS = (int)0x1,
   MAX_SQIF_DATAPATH_PERF_COUNTER_SEL       = (int)0x1
};
#define NUM_SQIF_DATAPATH_PERF_COUNTER_SEL (0x2)
typedef enum sqif_datapath_perf_counter_sel_enum sqif_datapath_perf_counter_sel;
