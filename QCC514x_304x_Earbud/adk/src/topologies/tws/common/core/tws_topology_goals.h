...
typedef enum
{
    ...
    /*! Goal is to disconnect from the LRU handset. */
    tws_topology_goal_disconnect_lru_handset,

    /*! Goal is to start the watchdog */
    tws_topology_goal_start_watchdog,

    /*! Goal is to stop the watchdog */
    tws_topology_goal_stop_watchdog,
