...
enum
{
    ...
    pbapc_app_Primary_Folder_Version,
    pbapc_app_Secondary_Folder_Version,
    pbapc_app_vCard_Selector,
    pbapc_app_Database_Identifier,
    pbapc_app_vCard_Selector_Operator,
    pbapc_app_Reset_New_Missed_Calls,
    pbapc_app_Supported_Features
};
