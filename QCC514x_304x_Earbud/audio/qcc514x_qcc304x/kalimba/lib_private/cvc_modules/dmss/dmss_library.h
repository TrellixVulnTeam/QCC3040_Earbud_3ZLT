...
// -----------------------------------------------------------------------------
// DMSS SNR DATA OBJECT
// -----------------------------------------------------------------------------
#define $dmss.snr.Z1_FIELD                  MK1 * 0
#define $dmss.snr.PARAM_FIELD               ADDR_PER_WORD + $dmss.snr.Z1_FIELD
#define $dmss.snr.PTR_VARIANT_FIELD         ADDR_PER_WORD + $dmss.snr.PARAM_FIELD

// Internal fields
#define $dmss.snr.SMOOTH_FACTOR             ADDR_PER_WORD + $dmss.snr.PTR_VARIANT_FIELD
#define $dmss.snr.NOISE_EST_FIELD           ADDR_PER_WORD + $dmss.snr.SMOOTH_FACTOR
#define $dmss.snr.HIGH_NOISE_FLAG_FIELD     ADDR_PER_WORD + $dmss.snr.NOISE_EST_FIELD
#define $dmss.snr.STRUC_SIZE                1 +  ($dmss.snr.HIGH_NOISE_FLAG_FIELD >> LOG2_ADDR_PER_WORD)


// DMSS SNR User Paramters
#define $dmss.snr.param.NOISE_HIGH_THRESH   MK1 * 0
#define $dmss.snr.param.NOISE_LOW_THRESH    MK1 * 1
#define $dmss.snr.param.NOISEEST_TC         MK1 * 2
