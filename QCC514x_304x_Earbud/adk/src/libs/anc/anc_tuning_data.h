...
#define CAPABILITY_ID_ANC_TUNING                (0x40B2)
#else
...
typedef enum
{
    ...
    OFFSET_ANC1_USES_ANC0_RX_PCM_INPUT_L,
    ...
    OFFSET_ANC1_USES_ANC0_RX_PCM_INPUT_R,
...
#ifdef ANC_UPGRADE_FILTER
#define OFFSET_ANC_L_MAX                (OFFSET_ANC_USECASE_R)
#define ANC_SINGLE_INST_TUNING_CONFIG_DATA_SIZE    (OFFSET_ANC_L_MAX * (sizeof(uint32) / sizeof(uint16)))
#endif
...
#ifdef ANC_UPGRADE_FILTER
#define FFA_RXMIX_GAIN_OFFSET           getPsPayloadOffset(OFFSET_ANC_RX_MIX_FF_A_GAIN_L)
#define FFA_RXMIX_GAIN_SHIFT_OFFSET     getPsPayloadOffset(OFFSET_ANC_RX_MIX_FFa_SHIFT_L)
#endif
...
#ifdef ANC_UPGRADE_FILTER
#define FFB_RXMIX_GAIN_OFFSET           getPsPayloadOffset(OFFSET_ANC_RX_MIX_FF_B_GAIN_L)
#define FFB_RXMIX_GAIN_SHIFT_OFFSET     getPsPayloadOffset(OFFSET_ANC_RX_MIX_FFb_SHIFT_L)
#endif
...
#define FFA_GAIN_OFFSET_R               getPsPayloadOffset(OFFSET_ANC_FF_A_GAIN_R)
#define FFB_GAIN_OFFSET_R               getPsPayloadOffset(OFFSET_ANC_FF_B_GAIN_R)
#define FB_GAIN_OFFSET_R                getPsPayloadOffset(OFFSET_ANC_FB_GAIN_R)
...
#ifdef ANC_UPGRADE_FILTER
#define SELF_RXMIX_ENABLE_OFFSET        getPsPayloadOffset(OFFSET_SELF_RXMIX_ENABLE_L)
#define CROSS_RXMIX_ENABLE_OFFSET       getPsPayloadOffset(OFFSET_CROSS_RXMIX_ENABLE_L)
#endif
...
#define GAIN_FFA_MIC_OFFSET_L           getPsPayloadOffset(OFFSET_FF_A_FE_GAIN_L)
#define GAIN_FFA_MIC_OFFSET_R           getPsPayloadOffset(OFFSET_FF_A_FE_GAIN_R)
#define GAIN_FFB_MIC_OFFSET_L           getPsPayloadOffset(OFFSET_FF_B_FE_GAIN_L)
#define GAIN_FFB_MIC_OFFSET_R           getPsPayloadOffset(OFFSET_FF_B_FE_GAIN_R)
