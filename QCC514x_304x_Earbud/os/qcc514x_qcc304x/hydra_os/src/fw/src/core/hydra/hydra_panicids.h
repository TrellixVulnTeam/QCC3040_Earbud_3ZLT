...
/*   %%version */
     ...
     * argument is (event_group << 8 | event_index)
     */
    ...
    /**
     * An incoming MMU access from remote subsystem has failed.
     * Diatribe contains VM_LOOKUP_ERROR_FLAGS register value.
     */
    PANIC_HYDRA_INCOMING_REMOTE_MMU_ACCESS_FAILED = 0x10c8,
