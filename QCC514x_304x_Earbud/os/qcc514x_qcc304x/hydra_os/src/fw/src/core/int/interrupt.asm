...
// Note: The equivalent interrupt related code for FreeRTOS is in
// fw/src/core/sched_freertos/portasm.asm.
#ifdef OS_OXYGOS
.MODULE $interrupt;
   .DATASEGMENT DM;
...
#ifdef DEBUG_PACKETISER_STACK_CORRUPTION
   // Variables to detect corruption of registers used by packetiser
   .VAR/DM $_interrupt_entry_r7 = 0;
   .VAR/DM $_interrupt_exit_r7 = 0;
   .VAR/DM $_interrupt_entry_int_status = 0;
   .VAR/DM $_interrupt_entry_int_src = 0;
#endif
...
#ifdef DEBUG_PACKETISER_STACK_CORRUPTION
   M[$_interrupt_entry_r7] = r7;
   r0 = M[$INT_STATUS];
   M[$_interrupt_entry_int_status] = r0;
#endif
