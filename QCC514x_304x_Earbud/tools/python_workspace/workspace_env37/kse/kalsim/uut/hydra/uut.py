...
#
"""Kalsim UUT abstraction for kalsim"""
...
class HydraUut(UutBase):
    ...
    def message_register_handler(self, header, callback=None, flt=None):
        return self._message.register_message_handler(header, callback=callback, flt=flt)
