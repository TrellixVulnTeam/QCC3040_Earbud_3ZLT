...
from .util import get_buffer_stats


class HydraAudioDataService:
    ...
    def start(self, **kwargs):
        ...
        msg = [
            self._service_tag,
            kwargs.get('data_buffer_size', self._kwargs.get('data_buffer_size', 1024)),
            kwargs.get('metadata_buffer_size', self._kwargs.get('metadata_buffer_size', 0)),
            kwargs.get('kick_required', self._kick_required),
            kwargs.get('device_type', self._device_type),
            kwargs.get('metadata_header_length', self._kwargs.get('metadata_header_length', 0)),
            kwargs.get('connect_endpoint', self._kwargs.get('connect_endpoint', 0)),
        ]
    ...
    def get_space(self):
        ...
        if payload[0] != KICK_SERVICE_CONSUMER:
    ...
    def get_buffer_stats(self):
        ...
        return get_buffer_stats(self.param.data_rd_handle,
                                self.param.data_wr_handle,
    ...
    def get_metadata_buffer_stats(self):
        ...
        return get_buffer_stats(self.param.meta_data_rd_handle,
                                self.param.meta_data_wr_handle,
                                buffer_size=self._md_buffer_size,
                                buffer_width=self._md_buffer_width)
