...
static void handle_heart_rate_client_gatt_manager_msg(Task task, MessageId id, Message msg)
{
    ...
    GATT_HEART_RATE_CLIENT_DEBUG_INFO(("handle_heart_rate_client_gatt_manager_msg MESSAGE:0x%x\n", id));
...
static void handle_heart_rate_ext_message(MessageId id)
{
    ...
    GATT_HEART_RATE_CLIENT_DEBUG_PANIC(("Unknown Message MESSAGE:0x%x received from GATT lib \n",id));
}
...
static void  handle_heart_rate_internal_message(Task task, MessageId id, Message msg)
{
    ...
    GATT_HEART_RATE_CLIENT_DEBUG_INFO(("handle_heart_rate_internal_messge MESSAGE:heart_rate_client_internal_msg_t:0x%x\n",
                                      id));
...
{
    GATT_HEART_RATE_CLIENT_DEBUG_INFO(("heart_rate_client_msg_handler MESSAGE:heart_rate_client_internal_msg_t:0x%x\n",
                                      id));
