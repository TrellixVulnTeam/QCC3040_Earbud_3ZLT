...
/*******************************************************************************
 ...
 VALUES
    ...
    CVCEB2MIC_IE_WB
                   - CVC 2 Mic Earbud In-Ear Wideband
    CVCEB3MIC_MONO_IE_WB
                   - CVC 3 Mic Earbud Mono In-Ear Wideband
    CVCEB2MIC_IE_NB
                   - CVC 2 Mic Earbud In-Ear Narrowband
    CVCEB3MIC_MONO_IE_NB
                   - CVC 3 Mic Earbud Mono In-Ear Narrowband
    DBE_FULLBAND
                   - DBE_FULLBAND
    ...
    DOWNLOAD_APVA
                   - Downloadable Amazon Pryon Voice Assistant, Amazon's phrase
                     recognition engine
    DOWNLOAD_AANC_MONO_16K
                   - Downloadable AANC Mono 16k
    DOWNLOAD_CVC_FBC
                   - cVc Full-band echo canceller
    DOWNLOAD_AANC_LITE_16K
                   - Downloadable AANC Lite 16k
    DOWNLOAD_EARBUD_FIT_TEST_16K
                   - Downloadable Earbud Fit Test 16k
    DOWNLOAD_SVAD
                   - Downloadable Self Voice Activity Detector
    DOWNLOAD_CVCEB3MIC_MONO_IE_WB
                   - Downloadable CVC 3 Mic Earbud Mono In-Ear Wideband
    DOWNLOAD_CVCEB2MIC_IE_WB
                   - Downloadable CVC 2 Mic Earbud In-Ear Wideband
    DOWNLOAD_CVCEB2MIC_IE_NB
                   - Downloadable CVC 2 Mic Earbud In-Ear Narrowband
    DOWNLOAD_CVCEB3MIC_MONO_IE_NB
                   - Downloadable CVC 3 Mic Earbud Mono In-Ear Narrowband
    DOWNLOAD_DM_PROFILER
                   - Downloadable DM Profiler
    DUMMY_ID_FORCE_INT
...
typedef enum
{
    ...
    CAP_ID_CVCEB2MIC_IE_WB = 0x0082,
    CAP_ID_CVCEB3MIC_MONO_IE_WB = 0x0083,
    CAP_ID_CVCEB2MIC_IE_NB = 0x0085,
    CAP_ID_CVCEB3MIC_MONO_IE_NB = 0x0086,
    ...
    CAP_ID_GVA = 0x00C5,
    CAP_ID_APVA = 0x00C6,
    CAP_ID_AANC_MONO_16K = 0x00C7,
    CAP_ID_AANC_LITE_16K = 0x00C9,
    CAP_ID_EARBUD_FIT_TEST_16K = 0x00CA,
    ...
    CAP_ID_DOWNLOAD_GVA = 0x409B,
    CAP_ID_DOWNLOAD_APVA = 0x409C,
    CAP_ID_DOWNLOAD_AANC_MONO_16K = 0x409F,
    CAP_ID_DOWNLOAD_CVC_FBC = 0x409e,
    CAP_ID_DOWNLOAD_AANC_LITE_16K = 0x40A1,
    CAP_ID_DOWNLOAD_EARBUD_FIT_TEST_16K = 0x40A2,
    CAP_ID_DOWNLOAD_SVAD = 0x40A6,
    CAP_ID_DOWNLOAD_CVCEB3MIC_MONO_IE_WB = 0x40A5,
    CAP_ID_DOWNLOAD_CVCEB2MIC_IE_WB = 0x40A7,
    CAP_ID_DOWNLOAD_CVCEB2MIC_IE_NB = 0x40A8,
    CAP_ID_DOWNLOAD_CVCEB3MIC_MONO_IE_NB = 0x40A9,
    CAP_ID_DOWNLOAD_DM_PROFILER = 0x40AA,
