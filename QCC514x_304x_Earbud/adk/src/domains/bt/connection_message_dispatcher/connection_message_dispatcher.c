...
Task ConnectionMessageDispatcher_RegisterLeIsoClient(Task client)
{
    return connectionMessageDispatcher_RegisterClient(client, le_iso_group);
}
...
static group_type_t connectionMessageDispatcher_GetGroupType(MessageId id)
{
    ...
    switch (id)
    {
        ...
        case CL_DM_BLE_EXT_SCAN_CTRL_SCAN_INFO_IND:
        ...
        case CL_DM_ISOC_CIS_CONNECT_CFM:
        case CL_DM_ISOC_CIS_CONNECT_IND:
        case CL_DM_ISOC_CIS_DISCONNECT_CFM:
        case CL_DM_ISOC_CIS_DISCONNECT_IND:
        case CL_DM_ISOC_CONFIGURE_CIG_CFM:
        case CL_DM_ISOC_REMOVE_CIG_CFM:
        case CL_DM_ISOC_SETUP_ISOCHRONOUS_DATA_PATH_CFM:
        case CL_DM_ISOC_REMOVE_ISO_DATA_PATH_CFM:
        case CL_DM_ISOC_CREATE_BIG_CFM:
        case CL_DM_ISOC_TERMINATE_BIG_CFM:
        ...
        case CL_DM_REMOTE_EXTENDED_FEATURES_CFM:
            DEBUG_LOG("connectionMessageDispatcher_GetGroupType, misc_group message, MESSAGE:0x%x", id);
            group = misc_group;
            break;

        default:
            DEBUG_LOG("connectionMessageDispatcher_GetGroupType, unknown_group message, MESSAGE:0x%x", id);
            group = unknown_group;
            break;
    }
