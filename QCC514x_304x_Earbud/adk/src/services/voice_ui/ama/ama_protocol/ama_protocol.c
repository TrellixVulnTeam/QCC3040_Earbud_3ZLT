...
static char *amaProtocol_GetSerialNumber(void)
{
...
ama_device_config_t * AmaProtocol_GetDeviceConfiguration(void)
{
    ...
    {
        ama_config->device_config.serial_number = amaProtocol_GetSerialNumber();
    }
                 ...
                 const ama_config_t *config)
{
    ...
    AmaNotifyAppMsg_TransportSwitch(ama_transport_none);
    AmaState_Init();
...
void AmaProtocol_TransportConnCfm(void)
{
