...
/*!
    @brief Set the ability to use the larger MTU

    @param addr The address of the remote device.
    @param use_large_mtu enable the large mtu
...
/*!
    ...
    If the remote device does NOT support Delay Reporting, then the CFM will show the status #a2dp_operation_fail.
*/
