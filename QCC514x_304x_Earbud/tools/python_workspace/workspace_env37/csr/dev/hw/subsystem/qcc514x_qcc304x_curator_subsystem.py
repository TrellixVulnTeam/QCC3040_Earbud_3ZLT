...
QCC514X_QCC304XCuratorSubsystem and QCC514X_QCC304XCuratorD00Subsystem.
"""
...
class QCC514X_QCC304XCuratorSubsystem(CuratorSubsystem):
    """
    QCC514X_QCC304X-specific Curator functionality
    """
    @property
    def sqif(self):
        '''
    ...
    def config_sqif_pios(self):
        ...
        cur.fields['CHIP_PIO44_PIO47_MUX_CONTROL'] = 0xbb00
        cur.fields['CHIP_PIO48_PIO51_MUX_CONTROL'] = 0xbbbb
...
class QCC514X_QCC304XCuratorD00Subsystem(QCC514X_QCC304XCuratorSubsystem, IsQCC514X_QCC304X):
    #pylint: disable=too-many-ancestors
    """\
    QCC514X_QCC304X D00 Curator Subsystem Proxy
    """
    # CuratorSubsystem Compliance

    def _create_curator_core(self, access_cache_type):
        from csr.dev.hw.core.qcc514x_qcc304x_curator_core \
            import QCC514X_QCC304XCuratorD00Core
        core = QCC514X_QCC304XCuratorD00Core(self)
