...
#if defined(CORVUS_YD300) || defined(USE_CH430_LED_MAP)
 ...
 */
#ifdef HAVE_RDP_UI
const led_pattern_t app_led_pattern_charging_error[] =
{
    LED_LOCK,
    LED_ON(LED_RED),
    LED_UNLOCK,
...
const led_pattern_t app_led_pattern_charging_complete[] =
{
    LED_LOCK,
    LED_ON(LED_GREEN),
    LED_WAIT(D_SEC(4)),
    LED_WAIT(D_SEC(4)),
    LED_WAIT(D_SEC(2)), // LED pattern has a 13 bit field so break the "10000ms" into chunks under 4095 each
    LED_OFF(LED_GREEN),
    LED_UNLOCK,
    LED_END
};
...
const led_pattern_t app_led_pattern_charging_low[] =
{
    LED_LOCK,
    LED_ON(LED_RED),
    LED_WAIT(500),
...
const led_pattern_t app_led_idle_production[] =
{
    LED_LOCK,
    LED_SYNC(1000),
    LED_ON(LED_GREEN), LED_WAIT(200), LED_OFF(LED_GREEN), LED_WAIT(200),
    LED_ON(LED_GREEN), LED_WAIT(200), LED_OFF(LED_GREEN), LED_WAIT(3000),
    LED_UNLOCK,
    LED_REPEAT(0, 0),
};

const led_pattern_t app_led_in_ear_production[] =
{
    LED_LOCK,
    LED_ON(LED_BLUE), LED_WAIT(200), LED_OFF(LED_BLUE), LED_WAIT(200),
    LED_ON(LED_BLUE), LED_WAIT(200), LED_OFF(LED_BLUE), LED_WAIT(1000),
    LED_UNLOCK,
    LED_END
};

const led_pattern_t app_led_out_ear_production[] =
{
    LED_LOCK,
    LED_ON(LED_BLUE), LED_WAIT(200), LED_OFF(LED_BLUE), LED_WAIT(200),
    LED_ON(LED_BLUE), LED_WAIT(200), LED_OFF(LED_BLUE), LED_WAIT(200),
