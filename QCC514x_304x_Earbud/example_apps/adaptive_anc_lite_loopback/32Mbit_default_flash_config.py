...

{
    ...
    "layout": [
        ...
        ("apps_p0",         {"capacity": 158 * 4 * 1024,  "authenticate": True, "src_file_signed": True}),
        ...
        ("ro_cfg_fs",       {"capacity":  61 * 4 * 1024,  "authenticate": False}),
        ("ro_fs",           {"capacity":  93 * 4 * 1024,  "authenticate": False})
    ]
}
