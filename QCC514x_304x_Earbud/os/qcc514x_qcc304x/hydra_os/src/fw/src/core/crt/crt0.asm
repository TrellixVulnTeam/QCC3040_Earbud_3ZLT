...
$reset_minim:
    ...
    // If STACK_END_ADDR is non-zero, we've branched through zero
    ...
    // check.
    // STACK_END_ADDR is used rather than STACK_START_ADDR as it's possible
    // STACK_START_ADDR has been set to 0 as a method of disabling hardware
    // stack protection.
    Null = M[$STACK_END_ADDR];
