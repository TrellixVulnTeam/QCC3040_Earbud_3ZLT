...
/*! Structure describing HDMA internal state. */
typedef struct
{
...
/*! Enum Internal messages sent by hdma to itself. */
typedef enum
{
    /*! Internal timer event sent by hdma to itself. */
    HDMA_INTERNAL_TIMER_EVENT = INTERNAL_MESSAGE_BASE,

    /*! This must be the final message */
    HDMA_INTERNAL_MESSAGE_END
} hdma_internal_messages;
ASSERT_INTERNAL_MESSAGES_NOT_OVERFLOWED(HDMA_INTERNAL_MESSAGE_END)
