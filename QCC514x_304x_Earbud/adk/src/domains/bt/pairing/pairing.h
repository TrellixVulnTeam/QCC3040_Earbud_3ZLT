...
\version    
\file
\defgroup   pairing BlueTooth pairing
\ingroup    bt_domain
...
typedef struct
{
                            /*!  The pairing activity being reported */
    pairingActivityStatus status;   
    uint8 user_initiated;   /*!< Whether pairing is currently user_initiated */
                            /*!  The address affected. For most messages this
                                 will be empty. 
