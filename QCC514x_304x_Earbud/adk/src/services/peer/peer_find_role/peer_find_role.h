...
typedef enum
{
    ...
    PEER_FIND_ROLE_PREPARE_FOR_ROLE_SELECTION,
        /*! Peer Find Role has been initialised */
    PEER_FIND_ROLE_INIT_CFM,

    /*! This must be the final message */
    PEER_FIND_ROLE_MESSAGE_END
...
typedef enum {
    ...
    /*! Transitory setting that selects the role based on Left/Right
        The right device will become peer_find_role_fixed_role_primary */
    peer_find_role_fixed_role_automatic,
