...
#define AG_EVRA_SUPPORTED           (1<<12)
#define AG_EVRA_TEXT_SUPPORTED      (1<<13)
...
typedef struct
{
    ...
    unsigned                    link_supports_swb:1;
    unsigned                    unused:8;
} hfp_link_data_bitfields;
...
typedef struct
{
    ...
    hfp_link_data_bitfields     bitfields;
