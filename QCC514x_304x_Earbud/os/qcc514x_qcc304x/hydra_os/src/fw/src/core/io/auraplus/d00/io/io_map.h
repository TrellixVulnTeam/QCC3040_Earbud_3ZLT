...
/* Declarations of read only registers */
extern volatile uint32  KALIMBA_READ_CACHE_ARBITRATION_WAIT_COUNTER_DM;  /* R   24 bits */
extern volatile uint32  KALIMBA_READ_CACHE_ARBITRATION_WAIT_COUNTER_PM;  /* R   24 bits */
extern volatile uint32  KALIMBA_READ_CACHE_DEBUG_DATA;       /* R   32 bits */
extern volatile uint32  KALIMBA_READ_CACHE_FSM_WAIT_COUNTER_DM;  /* R   24 bits */
extern volatile uint32  KALIMBA_READ_CACHE_FSM_WAIT_COUNTER_PM;  /* R   24 bits */
extern volatile uint32  KALIMBA_READ_CACHE_NVMEM_WAIT_COUNTER_DM;  /* R   32 bits */
extern volatile uint32  KALIMBA_READ_CACHE_NVMEM_WAIT_COUNTER_PM;  /* R   32 bits */
...
/* Declarations of read/write/mixed registers */
extern volatile uint32  APPS_SYS_PIO_DRIVE[3];               /* RW  80 bits */
...
extern volatile uint32  APPS_SYS_PIO_DRIVE_ENABLE[3];        /* RW  80 bits */
...
/* Declarations of read only registers */
extern volatile uint32  APPS_SYS_PIO_STATUS[3];              /* R   80 bits */
...
extern volatile uint32  SQIF_CONF;                           /* RW  13 bits */
...
extern volatile uint32  SQIF_RAM_CONF;                       /* RW   9 bits */
extern volatile uint32  SQIF_RAM_INST;                       /* RW  16 bits */
...
extern volatile host_sys_block_ids  HOST_SYS_SCALED_CLK_VETO_EN;         /* RW   5 bits */
extern volatile uint32  HOST_SYS_SDIO_SIDEBAND_INTERRUPT_OUTPUT_PIO_CTRL;  /* RW   7 bits */
extern volatile uint32  HOST_SYS_SPI_ENABLES;                /* RW   2 bits */
...
extern volatile uint32  USB_TX_PREFETCH_RAM_0_TO_3_WABL;     /* RW  12 bits */
...
extern volatile uint32  USB_TX_PREFETCH_RAM_READ_ASSIST;     /* RW   3 bits */
...
extern volatile uint32  APPS_SCALED_CLOCK_CONTROLS;          /* RW   3 bits */
extern volatile uint32  APPS_SPI_CLK_DEGLITCH_ENABLE;        /* RW   1 bits */
...
extern volatile uint32  APPS_SYS_PIO_MUX[3];                 /* RW  80 bits */
...
extern volatile uint32  APPS_SYS_SDIO_1P8V_PIO_CONTROLS;     /* RW  18 bits */
...
extern volatile uint32  APPS_SYS_SQIF1_PRESENT;              /* R    2 bits */
...
#ifndef __IO_MAP_H__IO_MAP_MODULE_APPS_BANKED_TBUS_INT_P1
#define __IO_MAP_H__IO_MAP_MODULE_APPS_BANKED_TBUS_INT_P1

/* -- apps_banked_tbus_int_p1 -- Control of banked TBus interrupts for P1 -- */

/* Declarations of read/write/mixed registers */
extern volatile uint32  APPS_BANKED_TBUS_INT_P1_ACCESS_CTRL;  /* RW   4 bits */
extern volatile uint32  APPS_BANKED_TBUS_INT_P1_ENABLES;     /* RW  16 bits */
extern volatile apps_banked_tbus_int_p1__mutex_lock_enum  APPS_BANKED_TBUS_INT_P1_MUTEX_LOCK;  /* RW   4 bits */
extern volatile uint32  APPS_BANKED_TBUS_INT_P1_STATUS;      /* RW  16 bits */

#endif /* __IO_MAP_H__IO_MAP_MODULE_APPS_BANKED_TBUS_INT_P1 */
#endif /* !defined(IO_DEFS_LIMIT_MODULES) || defined(IO_DEFS_MODULE_APPS_BANKED_TBUS_INT_P1) */
...
extern volatile uint32  CLKGEN_DISABLE_TBUS_CORE_CLK_SPEEDUP;  /* RW   1 bits */
...
extern volatile uint32  KALIMBA_PIO_INT_PIO1_EVENT_CAUSE_CLEAR_DATA[3];  /* RW  80 bits */
...
extern volatile uint32  KALIMBA_PIO_INT_PIO1_EVENT_FALLING_ENABLE[3];  /* RW  80 bits */
...
extern volatile uint32  KALIMBA_PIO_INT_PIO1_EVENT_RISING_ENABLE[3];  /* RW  80 bits */
...
extern volatile uint32  KALIMBA_PIO_INT_PIO2_EVENT_CAUSE_CLEAR_DATA[3];  /* RW  80 bits */
...
extern volatile uint32  KALIMBA_PIO_INT_PIO2_EVENT_FALLING_ENABLE[3];  /* RW  80 bits */
...
extern volatile uint32  KALIMBA_PIO_INT_PIO2_EVENT_RISING_ENABLE[3];  /* RW  80 bits */
...
extern volatile uint32  KALIMBA_PIO_INT_TIMER_SW3_EVENT_PIO_INVERT[3];  /* RW  80 bits */
...
extern volatile uint32  KALIMBA_PIO_INT_TIMER_SW3_EVENT_PIO_MASK[3];  /* RW  80 bits */
...
/* Declarations of read only registers */
extern volatile uint32  KALIMBA_PIO_INT_PIO1_EVENT_CAUSE[3];  /* R   80 bits */
...
extern volatile uint32  KALIMBA_PIO_INT_PIO2_EVENT_CAUSE[3];  /* R   80 bits */
...
extern volatile uint32  KALIMBA_PIO_INT_TIMER_SW3_EVENT_PIO_STATUS[3];  /* R   80 bits */
