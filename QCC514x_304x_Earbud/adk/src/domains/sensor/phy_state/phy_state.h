...
typedef enum
{
    PHY_STATE_INTERNAL_IN_CASE_EVENT = INTERNAL_MESSAGE_BASE,
    ...
    /*! This must be the final message */
    PHY_STATE_INTERNAL_MESSAGE_END
...
/*! \brief Get the latest reported physical state of the device.

    \note This may differ from the current physical state of the device,
	      which may currently be rate limited to prevent excessive reporting.

    \return phyState Last reported physical state of the device.
*/
